...
class LogHelper extends Component{	
	public static function setPublicSubmitted2($model){
...
//		$model->request_time = Timeanddate::getCurrentDate();
	...
	public static function setPublicSubmittedGuest($model){
		$model->created_date = Timeanddate::getCurrentDateTime();
		$model->created_user = -10; //Guest
//		$model->request_time = Timeanddate::getCurrentDate();
		$model->created_ip_address = IPAddressFunction::getUserIPAddress();
	...
	public static function setCreatedLog($model){
		$model->created_date = Timeanddate::getCurrentDateTime();
...
//		$model->request_time = Timeanddate::getCurrentDate();
	...
	public static function setCreatedLog2($model){
		$model->created_date = Timeanddate::getCurrentDateTime();
		$model->created_id_user = Yii::$app->user->identity->id;
//		$model->request_time = Timeanddate::getCurrentDate();
		$model->created_ip_address = IPAddressFunction::getUserIPAddress();
	...
	public static function setModifiedLog($model){
		$model->modified_date = Timeanddate::getCurrentDateTime();
		$model->modified_id_user = Yii::$app->user->identity->id;
//		$model->request_time = Timeanddate::getCurrentDate();
		$model->modified_ip_address = IPAddressFunction::getUserIPAddress();
