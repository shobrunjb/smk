 ...
 */
class HrmPegawaiOrganizationController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionIndexKantor()
    {
        $searchModel = new HrmPegawaiSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('index-perusahaan', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
    ...
    public function actionCheckUniqueId()
    {
        $searchModel = new HrmPegawaiSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);

        return $this->render('check-unique-id', [
            'searchModel' => $searchModel,
            'dataProvider' => $dataProvider,
        ]);
    }
