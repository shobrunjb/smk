...
class AssetItem extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id_asset_master', 'number2', 'id_asset_received', 'id_asset_item_location'], 'required'],
            [[
                'id_asset_master', 'id_asset_received', 'id_asset_item_location',
                'id_type_asset_item1', 'id_type_asset_item2', 'id_type_asset_item3',
                'id_type_asset_item4', 'id_type_asset_item5',  'id_customer'
            ], 'integer'],
            [['number1', 'number2', 'number3', 'picture2', 'picture3', 'picture4', 'picture5', 'label1', 'label2', 'label3', 'label4', 'label5'], 'string', 'max' => 250],
    ...
    {
        return $this->hasOne(TypeAssetItem1::className(), ['id_type_asset_item' => 'id_type_asset1']);
    }
    ...
    public static function getListAssetItemByTypeAsset1($id_type_asset1)
    {
        $models = AssetItem::find()
        ...
        foreach ($models as $model) {
            ...
            $LIST_ITEM[$model->id_asset_item] = $assetmaster . " -- " . $model->number2;
        }
