...
class HrmPegawai extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['jenis_kelamin', 'golongan_darah', 'agama', 'status_pernikahan', 'kartu_kesehatan', 'status_tenaga_kerja', 'reg_status_pegawai', 'alamat_termutakhir', 'alamat_sesuai_identitas', 'no_bpjs'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'pdk_id_tingkatpendidikan' => 'Pendidikan Terakhir',
            ...
            'alamat_sesuai_identitas' => 'Alamat',
    ...
    */
    ...
    {
        return $this->hasOne(HrmStatusPegawai::className(), ['id_hrm_status_pegawai' => 'id_hrm_status_pegawai']);
    }

    public function getJabatan()
    {
        return $this->hasOne(Jabatan::className(), ['id_jabatan' => 'jbt_id_jabatan']);
    }
    ...
    public function getKantor()
    {
        return $this->hasOne(Kantor::className(), ['id_kantor' => 'pos_id_hrm_kantor']);
    }

    public function getTingkatPendidikan()
    {
        return $this->hasOne(MstTingkatPendidikan::className(), ['id_mst_tingkat_pendidikan' => 'pdk_id_tingkatpendidikan']);
    }

    public static function getIdPegawaiFromUserId(){
    ...
    public static function getIDPerusahaanFromUserId(){
        $pegawai = \backend\models\HrmPegawai::find()
                ->where(['id_user' => Yii::$app->user->identity->id])
                ->one();
        if($pegawai != null) {
            return $pegawai->id_perusahaan;
        }else{
            return 0;
        }
