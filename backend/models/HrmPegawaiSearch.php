...
/**
 * HrmPegawaiSearch represents the model behind the search form of `app\models\HrmPegawai`.
 */
class HrmPegawaiSearch extends HrmPegawai
{
    ...
    public static function checkHashPerusahaan($id_user){
        $value = false;
