...
$this->title = 'Data Aset Kendaraan';
...
<div class="asset-item-index box box-primary">
    ...
    <div class="box-header with-border">
        <p>
            <?= Html::a(CommonActionLabelEnum::CREATE . ' ' . AppVocabularySearch::getValueByKey(' Aset'), ['create'], ['class' => 'btn btn-success']) ?>
            <?php //= Html::a(CommonActionLabelEnum::SCAN, ['scan-asset-item'], ['class' => 'btn btn-success']) 
            ?>
            ...
            'columns' => [
                ...
                */
                ...
                [
                    ...
                    // 'filter' X=> Html::activeDropDownList($searchModel, 'id_type_asset1', $dataList1, ['class' => 'form-control']),
                ],
                // [
                //     'label' => 'Status',
