...
$this->title = 'Matching Personal vs Environment';
$this->params['breadcrumbs'][] = $this->title;

$dataListEnvironment = ['' => 'Pilih'] + \yii\helpers\ArrayHelper::map(\backend\models\Kabupaten::find()
         ->orderBy([
            'nama_kabupaten' => SORT_ASC
            ])
        ->all(), 'id_kabupaten', 'nama_kabupaten');
?>
            ...
            'columns' => [
                ...
                */
                ...
                [
                    ...
                    'value' => function ($data) {
                        if (isset($data->kantor)) {
                            return $data->kantor->nama_kantor;
                        } else {
                            return "--".$data->pos_id_hrm_kantor;
                        }
                    },
                ...
                [
                    ...
                    //'value' => function ($data) use ($ip) {
                    'value' => function ($data) {
                        if (isset($data->kantor->kabupaten)) {
                            return $data->kantor->kabupaten->nama_kabupaten;
                        } else {
                            return "--";
                        }
                    },
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        if(isset($data->kantor)){
                        $d = \common\utils\EncryptionDB::encryptor('encrypt', $data->kantor->id_kabupaten);
                        return Html::a(
                            '<i class="fa fa-fw fa-check-square"></i> Match',
                            ['matching-personal-environment/view', 'i' => $i,'d' => $d],
                            ['class' => 'btn btn-warning btn-xs']
                        );
                    }
                    // return Html::a(
                    //     '<i class="fa fa-fw fa-check-square"></i> Match',
                    //     ['matching-personal-environment/view', 'i' => $i],
                    //     ['class' => 'btn btn-warning btn-xs']
                    // );
                    }
                ],
                ...
                [
                    'label' => 'Ack Kecocokan Environment',
                    'format' => 'raw',
                    //'value' => function ($data) use ($ip) {
                    'value' => function ($data) {
                        $result = \backend\models\MatchingEnvironmentResult::find()
