...
$this->title = 'Penilaian Kinerja Pegawai XX';
        ...
        <p>
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($data) use ($year, $periode){
                        $i = \common\utils\EncryptionDB::encryptor('encrypt', $data->id_smk_pegawai_tahunan);

                        return Html::a(
                            '<i class="fa fa-fw fa-pencil"></i> Kerjakan',
                            ['fill', 'i' => $i,'year' =>$year,'periode' =>$periode],
