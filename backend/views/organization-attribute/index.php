...
<div class="perusahaan-index box box-primary">
    ...
    <div class="box-body">
        ...
        <?= GridView::widget([
            ...
            'panel' => ['type' => 'primary', 'heading' => '<span class="fa fa-cube"></span> Perusahaan'],
            'export' => [
                'label' => 'Export',
            ],
            'pager' => [
            ...
            'columns' => [
                ...
                [
                    ...
                    'value' => function ($data) { 
                        //$i = $data->id_jabatan;
                        $i = \common\utils\EncryptionDB::encryptor('encrypt', $data->id_perusahaan);

                        return Html::a(
                            '<i class="fa fa-fw fa-edit"></i> Ubah Atribut',
                            ['organization-attribute/change', 'i' => $i],
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(
                            ...
                            ['organization-attribute/view', 'i' => $i],
