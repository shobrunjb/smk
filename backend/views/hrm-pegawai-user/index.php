...
$this->title = 'Generate Username untuk Pegawai';
...
<div class="hrm-pegawai-index box box-primary">
    ...
    <div class="box-body">
        ...
        <?= GridView::widget([
            ...
            'panel' => ['type' => 'primary', 'heading' => '<span class="fa fa-cube"></span> Generate user pegawai TKBM'],
            'export' => [
                'label' => 'Export',
            ],
            'pager' => [
                ...
                */
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        if ($data->id_user == 0) {
                            return Html::a(
                                '<i class="fa fa-fw fa-pencil"></i> Generate Username',
                                ['create-username', 'i' => $i],
                ...
                [
                    ...
                    //'value' => function ($data) use ($ip) {
                    'value' => function ($data) {
                        $i = \common\utils\EncryptionDB::encryptor('encrypt', $data->id_user);
                        //if($data->status_order == 'BELUM'){

                        if ($data->id_user != 0) {
                            return Html::a(
                                '<i class="fa fa-fw fa-recycle"></i> Reset Password',
