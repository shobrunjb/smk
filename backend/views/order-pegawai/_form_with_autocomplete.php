...
<div class="order-pegawai-form">
    ...
    */
    ...
    <?php /*= $form->field($model, 'id_asset_kendaraan1')->dropDownList(
        $listKapal,
        ['prompt' => 'Pilih Kapal ...']
    ); */ ?>

    <?php 
    echo $form->field($model, 'id_asset_kendaraan1')->widget(Select2::classname(), [
        'data' => $listKapal,
        'pluginOptions' => [
            'allowClear' => true
        ],
    ...
    */
    ...
    <?php /*= $form->field($model, 'id_asset_kendaraan2')->dropDownList(
        $listTongkang,
        ['prompt' => 'Pilih Tongkang ...']
    ); */ ?>

    <?php 
    echo $form->field($model, 'id_asset_kendaraan2')->widget(Select2::classname(), [
        'data' => $listTongkang,
        'pluginOptions' => [
            'allowClear' => true
        ],
    ...
    <?= $form->field($model, 'jumlah')->textInput(['maxlength' => 5]) ?>
