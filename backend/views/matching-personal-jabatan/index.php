...
$this->title = 'Matching Personal vs Jabatan';
$this->params['breadcrumbs'][] = $this->title;

$dataListJabatan = ['' => 'Pilih'] + \yii\helpers\ArrayHelper::map(\backend\models\Jabatan::find()
         ->orderBy([
            'nama_jabatan' => SORT_ASC
            ])
        ->all(), 'id_jabatan', 'nama_jabatan');
?>
            ...
            'columns' => [
                ...
                */
                ...
                [
                    ...
                    'filter'=>Html::activeDropDownList($searchModel, 'jbt_id_jabatan', $dataListJabatan, ['class' => 'form-control', 'prompt' => '-Pilih Jabatan-']),
                ],
                ...
                [
                    ...
                    'value' => function ($data) {
                        ...
                        return Html::a(
                            ...
                            ['matching-personal-jabatan/view', 'i' => $i],
                ...
                [
                    ...
                    'value' => function ($data) {
                        $result = \backend\models\MatchingJabatanResult::find()
                            ->where([
                                'id_jabatan' => $data->jbt_id_jabatan,
