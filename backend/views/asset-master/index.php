...
<div class="asset-master-index box box-success">
    ...
    <div class="box-header with-border">
        <p>
            <?= Html::a(CommonActionLabelEnum::CREATE . ' ' . AppVocabularySearch::getValueByKey(' Jenis Kendaraan'), ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    </div>
	...
	*/ ?>
    ...
    <div class="box-body table-responsive">
        <?= GridView::widget([
            'panel' => ['type' => 'primary', 'heading' => 'Data Jenis Aset'],
            'dataProvider' => $dataProvider,
            'filterModel' => $searchModel,
            'columns' => [
