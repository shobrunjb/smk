            ...
            */ ?>
            ...
            <div class="box-body">
              ...
              <div class="direct-chat-messages" id="chatlist">
                ...
                <?php
                    ...
                    $chats =  BeiPegawaiChat::find()->where(['id_pegawai' => $id_pegawai])->orderBy(['time_log' => SORT_ASC])->all();
            ...
            <div class="box-footer">
                ...
                <div class="input-group">
                  <input type="text" name="message" id="txtMsg" placeholder="Type Message ..." class="form-control" onchange="sendMessagePost()">
                      <span class="input-group-btn">
                        <input type="button" value="KIRIM" onclick="sendMessagePost2()" class="btn btn-primary btn-flat">
                      </span>
                      </span>
                </div>
