...
<div class="material-sampel-form">
    ...
    $listMateialRawKategori = \yii\helpers\ArrayHelper::map(\app\models\MaterialRawKategori1::find()->orderBy([
        'nama' => SORT_ASC
    ...
    <?php
    //Mengambil list dari tabel sebelah (purchase raw)
    $listSubcontractor = \yii\helpers\ArrayHelper::map(\app\models\Subcontractor::find()->orderBy([
