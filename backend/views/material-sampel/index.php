...
$listMateialRawKategori = ['' => 'Pilih'] +  \yii\helpers\ArrayHelper::map(\app\models\MaterialRawKategori1::find()
        ->orderBy([
            'nama' => SORT_ASC
        ])
        ->all(), 'id_material_raw_kategori', 'nama');

$listSubcontractor = ['' => 'Pilih'] +  \yii\helpers\ArrayHelper::map(\app\models\Subcontractor::find()
        ->orderBy([
