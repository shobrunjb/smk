...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2023 at 03:15 AM
...
(201, 'ID-PROJECT-TYPE-DEFAULT', 0, '1'),
(202, 'ID-PROJECT-ROLE-DEFAULT', 0, '102'),
(203, 'ID-PROJECT-ROLE-DEFAULT-JOIN', 0, '203'),
(211, 'ROLE PRODUCT OWNER', 1, 'PRODUCT OWNER');
...
('member', '35', NULL),
('member', '36', 2023),
('member', '37', 1679040642),
('member', '38', 1679707567),
('member', '39', 1679790029),
('member', '41', 1679791430),
('member', '42', 1679791892),
('member', '43', 1679875427),
('member', '44', 1680393970),
('member', '45', 1680395368),
('member', '46', 1680790825),
('member', '47', 1680949140),
('member', '52', 1680950510),
...
('/api/*', 2, NULL, NULL, NULL, 1680395242, 1680395242),
...
('/hrm-cv-asuransi/*', 2, NULL, NULL, NULL, 1672806560, 1672806560),
('/hrm-cv-keluarga/*', 2, NULL, NULL, NULL, 1672806557, 1672806557),
('/hrm-cv-kesehatan/*', 2, NULL, NULL, NULL, 1672806553, 1672806553),
('/hrm-cv-language-skill/*', 2, NULL, NULL, NULL, 1672806550, 1672806550),
('/hrm-cv-riwayat-pekerjaan/*', 2, NULL, NULL, NULL, 1672806547, 1672806547),
('/hrm-cv-riwayat-pendidikan/*', 2, NULL, NULL, NULL, 1672631217, 1672631217),
('/hrm-mst-bahasa/*', 2, NULL, NULL, NULL, 1672806520, 1672806520),
('/hrm-mst-jenis-absensi/*', 2, NULL, NULL, NULL, 1659435606, 1659435606),
('/hrm-mst-jenis-asuransi/*', 2, NULL, NULL, NULL, 1672806536, 1672806536),
('/hrm-mst-jenis-tunjangan-kesehatan/*', 2, NULL, NULL, NULL, 1672806533, 1672806533),
('/hrm-pegawai-user/*', 2, NULL, NULL, NULL, 1660626337, 1660626337),
('/hrm-pegawai/*', 2, NULL, NULL, NULL, 1629224181, 1629224181),
('/hrm-perusahaan-asurans/*', 2, NULL, NULL, NULL, 1672806626, 1672806626),
('/hrm-perusahaan-asuransi/*', 2, NULL, NULL, NULL, 1672806720, 1672806720),
...
('/jabatan-attribute/*', 2, NULL, NULL, NULL, 1678957536, 1678957536),
('/jabatan/*', 2, NULL, NULL, NULL, 1678956333, 1678956333),
...
('/matching-personal-jabatan/*', 2, NULL, NULL, NULL, 1680165628, 1680165628),
...
('/member-project/*', 2, NULL, NULL, NULL, 1680305029, 1680305029),
('/member-sprint/*', 2, NULL, NULL, NULL, 1680513885, 1680513885),
...
('/mst-jabatan-attribute-grade/*', 2, NULL, NULL, NULL, 1678957183, 1678957183),
('/mst-jabatan-attribute/*', 2, NULL, NULL, NULL, 1679034609, 1679034609),
('/mst-jenis-penyakit/*', 2, NULL, NULL, NULL, 1672806648, 1672806648),
...
('/pro-jabatan-attribute/*', 2, NULL, NULL, NULL, 1678952739, 1678952739),
...
('/project-member/*', 2, NULL, NULL, NULL, 1680303169, 1680303169),
('/project-mst-role/*', 2, NULL, NULL, NULL, 1680303175, 1680303175),
('/project-mst-type/*', 2, NULL, NULL, NULL, 1680303182, 1680303182),
('/project-product-backlog/*', 2, NULL, NULL, NULL, 1680443256, 1680443256),
('/project/*', 2, NULL, NULL, NULL, 1680273457, 1680273457),
...
('/site/join-company', 2, NULL, NULL, NULL, 1680271000, 1680271000),
('/site/login', 2, NULL, NULL, NULL, 1552641595, 1552641595),
('/site/logout', 2, NULL, NULL, NULL, 1552641595, 1552641595),
('/site/register-company', 2, NULL, NULL, NULL, 1680266911, 1680266911),
...
('/support-error/*', 2, NULL, NULL, NULL, 1680792593, 1680792593),
('/support-error/create', 2, NULL, NULL, NULL, 1680793354, 1680793354),
('/support-error/view', 2, NULL, NULL, NULL, 1680793359, 1680793359),
...
('admin', '/project-mst-role/*'),
('admin', '/project-mst-type/*'),
('admin', '/project/*'),
...
('member', '/member-sprint/*'),
('member', '/order-pegawai-list-member/*'),
('member', '/order-pegawai-list/*'),
('member', '/order-pegawai/*'),
('member', '/project-product-backlog/*'),
('member', '/site/index'),
('member', '/site/join-company'),
('member', '/site/register-company'),
('member', '/support-error/create'),
('member', '/support-error/view'),
...
--
-- Dumping data for table `bei_interview_batch`
--
...
--
-- Dumping data for table `bei_interview_session`
--
...
(100, 0, 1, 'Beranda', 'home', 'Beranda', 'Beranda', '/', 0, 'member', '', 1),
(1300, 0, 1, 'CV', 'file-o', 'CV', 'CV', '#', 0, 'member', '', 0),
...
(9100, 0, 1, 'Support', 'file-o', 'Support', 'Support', '#', 0, 'member', '', 1),
(9101, 9100, 0, 'Laporkan Error', 'fire-extinguisher', 'Laporkan Error', 'Laporkan Error', 'support-error/create', 0, 'member', 'MOBILE_TOP', 1),
...
(13000, 0, 1, 'Konfigurasi Atribut Pegawai', 'sliders', 'Konfigurasi Atribut Pegawai', 'Konfigurasi Atribut Pegawai', '#', 0, 'admin', '', 0),
...
(2, 'Teknik Informatika', 'Informatics', 1);
...
(1, 1, 'Telkom University', 'TelU', 'Jl. Telekomunikasi 1 Buah Batu', NULL),
(2, 2, 'SMA 25 Bandung', 'SMAN25', 'Jl. Ciwastra', 1),
(3, 12, 'SMP 30 Bandung', 'SMP30', 'Kiaracondong', 1);
...
--
-- Table structure for table `el_course`
--
...
--
-- Dumping data for table `el_course`
--

INSERT INTO `el_course` (`id_course`, `course_name`, `description`, `id_topic`, `course_price`) VALUES
(1, 'Belajar Python untuk Pemula', 'Di sini anda akan mendapatkan pelajaran tentang bagaimana membuat program python bagi pemula. Anda yang baru saja belajar tentang python dapat mengikuti program ini dengan baik', 1, 100000),
(2, 'Belajar Python GUI', 'Di sini anda akan belajar membuat python GUI dengan menggunakan TkInter. Anda akan bisa belajar dengan cepat bagaimana membuat tampilan berbasis dekstop menggunakan TkInter.', 1, 125000),
(3, 'Belajar Python Lanjutan untuk Statistika', 'Di sini anda akan belajar tentang python untuk statistika. Fungsi-fungsi statisik dalam python', 1, 0),
(4, 'Belajar Next JS bagi pemula', 'Di sini anda akan belajr membuat frontend menggunakan framework react js yang telah dibungkus dalam NEXST JS. Anda dengan mudah dapat belajar program ini.', 2, 0);

-- --------------------------------------------------------

--
-- Table structure for table `el_topic`
--

CREATE TABLE `el_topic` (
...
--
-- Dumping data for table `el_topic`
--

INSERT INTO `el_topic` (`id_topic`, `topic`, `description`) VALUES
(1, 'Python', NULL),
(2, 'Web', NULL),
(3, 'MySQL', NULL);
...
--
-- Table structure for table `hrm_cv_asuransi`
--
...
--
-- Dumping data for table `hrm_cv_asuransi`
--
...
(1, NULL, 16, 1, 1, 1, '2023-01-25', '2023-01-26', 20, '1231', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `hrm_cv_keluarga`
--
...
CREATE TABLE `hrm_cv_keluarga` (
  ...
  `id_mst_jenis_hub_keluarga` int(11) NOT NULL DEFAULT 0,
...
--
-- Dumping data for table `hrm_cv_keluarga`
--

INSERT INTO `hrm_cv_keluarga` (`id_keluarga`, `code_id`, `id_pegawai`, `kategori`, `id_mst_jenis_hub_keluarga`, `nama_lengkap`, `foto`, `tempat_lahir`, `tanggal_lahir`, `usia`, `usia_lebih_bulan`, `jenis_kelamin`, `status`, `pekerjaan`, `tanggal_menikah`, `tanggal_bercerai`, `tanggal_meninggal`, `golongan_darah`, `agama`, `status_pernikahan`, `status_tunjangan`, `tanggal_tunjangan`, `created_date`, `created_user`, `created_ip_address`, `modified_date`, `modified_user`, `modified_ip_address`) VALUES
(1, NULL, 16, 'ANAK', 0, 'Anaknya Farah', '', 'Bandung', '2023-06-14', NULL, NULL, 'WANITA', 'BELUM SEKOLAH', '', NULL, NULL, NULL, '', '', '', NULL, NULL, NULL, '', '', NULL, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrm_cv_kesehatan`
--
...
--
-- Dumping data for table `hrm_cv_kesehatan`
--
...
(1, NULL, 16, 1, 'Pasang Ring Jantung', 1, 'Jantung', '', 6, 1, '2023-01-26', '25000000.00', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `hrm_cv_language_skill`
--
...
--
-- Dumping data for table `hrm_cv_language_skill`
--
...
(1, 0, 16, NULL, 1, 'MAHIR', 1, 'Upload', 'asdasdas', NULL, NULL, NULL, NULL, NULL, NULL),
(2, 0, 16, NULL, 1, 'MAHIR', 1, 'Upload', 'asdasdas', NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `hrm_cv_riwayat_pekerjaan`
--
...
--
-- Dumping data for table `hrm_cv_riwayat_pekerjaan`
--
...
(1, NULL, 16, 'Startup HUBS', 'Programmer', 'Programmer CI', 2021, 2021, NULL, '', NULL, '', '', NULL, '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrm_cv_riwayat_pendidikan`
--
...
--
-- Dumping data for table `hrm_cv_riwayat_pendidikan`
--

INSERT INTO `hrm_cv_riwayat_pendidikan` (`id_riwayat_pendidikan`, `code_id`, `id_pegawai`, `id_mst_tingkat_pendidikan`, `id_sekolah`, `dari`, `sampai`, `id_jurusan`, `grade`, `foto_ijazah`, `foto_transkrip`, `created_date`, `created_user`, `created_ip_address`, `modified_date`, `modified_user`, `modified_ip_address`) VALUES
(15, NULL, 16, 12, 1, 2010, 2016, 1, '3.14', '', '', '2023-03-13', '36', '::1', '0000-00-00', '', ''),
(16, NULL, 16, 12, 1, 1910, 2016, 1, '3.14', '', '', '2023-03-13', '36', '::1', '0000-00-00', '', ''),
(17, NULL, 16, 11, 3, 2018, 2021, 1, '3.92', 'foto-amV3blNFNHV5WGg5ZFNCZjRqQytxUT09.png', 'foto-amV3blNFNHV5WGg5ZFNCZjRqQytxUT09.png', '2023-03-13', '36', '::1', '0000-00-00', '', ''),
(18, NULL, 16, 12, 2, 2018, 2021, 1, '3.92', 'foto-Wkt3L0Q5MHJpVXJKaG14RTRueTRZQT09.png', 'foto-Wkt3L0Q5MHJpVXJKaG14RTRueTRZQT09.png', '2023-03-13', '36', '::1', '0000-00-00', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrm_mst_bahasa`
--
...
--
-- Dumping data for table `hrm_mst_bahasa`
--
...
--
-- Table structure for table `hrm_mst_jenis_asuransi`
--
...
--
-- Dumping data for table `hrm_mst_jenis_asuransi`
--
...
--
-- Table structure for table `hrm_mst_jenis_tunjangan_kesehatan`
--
...
--
-- Dumping data for table `hrm_mst_jenis_tunjangan_kesehatan`
--
...
INSERT INTO `hrm_pegawai` (`id_pegawai`, `id_perusahaan`, `userid`, `id_user`, `cid`, `no_dossier`, `NIP`, `nama_lengkap`, `foto`, `tempat_lahir`, `tanggal_lahir`, `usia`, `usia_lebih_bulan`, `jenis_kelamin`, `golongan_darah`, `tinggi_badan`, `berat_badan`, `agama`, `status_pernikahan`, `no_identitas_pribadi`, `NPWP`, `no_kartu_kesehatan`, `no_kartu_tenagakerja`, `kartu_kesehatan`, `no_kartu_keluarga`, `scan_ktp`, `scan_bpjs`, `scan_npwp`, `scan_paraf`, `scan_kk`, `scan_tandatangan`, `no_bpjs`, `id_hrm_status_pegawai`, `id_hrm_status_organik`, `status_tenaga_kerja`, `reg_tanggal_masuk`, `reg_tanggal_diangkat`, `reg_tanggal_training`, `reg_status_pegawai`, `tanggal_mpp`, `tanggal_pensiun`, `tanggal_terminasi`, `id_hrm_mst_jenis_terminasi_bi`, `gelar_akademik`, `gelar_profesi`, `pdk_id_tingkatpendidikan`, `pdk_sekolah_terakhir`, `pdk_jurusan_terakhir`, `pdk_ipk_terakhir`, `pdk_tahun_lulus`, `alamat_termutakhir`, `alamat_sesuai_identitas`, `id_propinsi`, `id_kabupaten`, `mobilephone1`, `mobilephone2`, `telepon_rumah`, `fax_rumah`, `email1`, `email2`, `id_kk_profil_posisi`, `jbt_id_jabatan`, `jbt_jabatan`, `jbt_id_tingkat_jabatan`, `jbt_no_sk_jabatan`, `jbt_tgl_keputusan`, `jbt_tanggal_berlaku`, `jbt_keterangan_mutasi`, `pkt_id_pangkat`, `pkt_no_sk`, `pkt_tgl_keputusan`, `pkt_tgl_berlaku`, `pkt_gaji_pokok`, `pkt_id_jenis_kenaikan_pangkat`, `pkt_eselon`, `pkt_ruang`, `pos_id_hrm_kantor`, `pos_id_hrm_unit_kerja`, `pos_kantor`, `pos_id_kk_profil_posisi`, `sta_total_hukuman_disiplin`, `sta_total_penghargaan`, `pst_masabakti_20`, `pst_masabakti_25`, `pst_masabakti_30`, `pst_masabakti_35`, `pst_masabakti_40`, `cuti_besar_terakhir_start`, `cuti_besar_terakhir_end`, `cuti_besar_terakhir_ke`, `cuti_besar_plan_1`, `cuti_besar_plan_2`, `cuti_besar_plan_3`, `cuti_besar_plan_4`, `cuti_besar_plan_5`, `cuti_besar_plan_6`, `cuti_besar_plan_7`, `cuti_besar_ambil_1`, `cuti_besar_ambil_2`, `cuti_besar_ambil_3`, `cuti_besar_ambil_4`, `cuti_besar_ambil_5`, `cuti_besar_ambil_6`, `cuti_besar_ambil_7`, `cuti_besar_aktual_1`, `cuti_besar_aktual_2`, `cuti_besar_aktual_3`, `cuti_besar_aktual_4`, `cuti_besar_aktual_5`, `cuti_besar_aktual_6`, `cuti_besar_aktual_7`, `cuti_besar_aktual_end_1`, `cuti_besar_aktual_end_2`, `cuti_besar_aktual_end_3`, `cuti_besar_aktual_end_4`, `cuti_besar_aktual_end_5`, `cuti_besar_aktual_end_6`, `cuti_besar_aktual_end_7`, `reff_id`, `created_date`, `created_user`, `created_ip_address`, `modified_date`, `modified_user`, `modified_ip_address`) VALUES
(3, 0, '196505091993092002', 17, 154698399, 0, '7789', 'Luffy', NULL, 'Soppeng', '1965-05-04', 54, 6, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', '1965-05-09', '1965-05-09', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Gugur Depan', 0, 0, '018292144444', NULL, NULL, NULL, 'depan@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'III', 'IV /B', NULL, NULL, 'BADAN KESATUAN BANGSA DAN POLITIK', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '2019-11-12', '196505091993092002', '192.168.30.25'),
(4, 201501, '9999', 35, 30930530, 0, '9999', 'Rosalinda', NULL, '', '0000-00-00', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 4, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Jakarta 28 Jakrta Urta', 0, 0, '8729123', NULL, NULL, NULL, 'sudirman@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-08-18', 'admin', '::1', '0000-00-00', '', ''),
(5, 201501, '', 23, 123767543, 0, '89111', 'Meli', NULL, '', '2021-08-30', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 4, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Jakarta 28 Jakrta Urta', 0, 0, '87291231', NULL, NULL, NULL, 'sudirman2@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-09-04', 'admin', '::1', '0000-00-00', '', ''),
(6, 201501, '', 25, 72566225, 0, '1810', 'Putri Handayani', NULL, '', '1982-09-01', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Gajah Mungkur 28', 0, 0, '08192131', NULL, NULL, NULL, 'sinung@ithb.ac.id', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2021-09-04', 'admin', '::1', '0000-00-00', '', ''),
(7, 201501, '', 21, 158841851, 0, '3600002', 'Dimas Rizqy Pangestu', NULL, '', '2022-08-16', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'menghills 82', 0, 0, '081295031068', NULL, NULL, NULL, 'dimasrzqy@telkom.ac.id', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-16', 'admin', '::1', '0000-00-00', '', ''),
(8, 201501, '', 20, 31331849, 0, '300001', 'Safinaty', NULL, '', '2000-10-08', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'gang soleh solihun', 0, 0, '081234567890', NULL, NULL, NULL, 'fyndy@telkom.ac.id', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-16', 'admin', '::1', '0000-00-00', '', ''),
(9, 201501, '', 22, 129948011, 0, '6518239', 'Bambang Pamungkas', NULL, '', '2000-10-08', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Palembang', 0, 0, '08123445678', NULL, NULL, NULL, 'BP20@email.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-08-31', 'admin', '::1', '0000-00-00', '', ''),
(10, 201501, '', 24, 104635558, 0, '2394236666666666', 'RANDY', NULL, '', '2022-08-30', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 4, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'PGA', 0, 0, '089999999999', NULL, NULL, NULL, 'MAIL@MAIL.COM', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-07', 'admin', '::1', '0000-00-00', '', ''),
(11, 201501, '', 28, 212202157, 0, '082280685058', 'zafir kun', NULL, '', '2022-09-07', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 1, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'palembang', 0, 0, '082280695489', NULL, NULL, NULL, 'zafirateambrebes@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-07', 'admin', '::1', '0000-00-00', '', ''),
(12, 201501, '', 26, 105493791, 0, '123465432', 'Firdy', NULL, '', '2000-10-08', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Tangerang', 0, 0, '081295035678', NULL, NULL, NULL, 'firdy@mail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-07', 'admin', '::1', '0000-00-00', '', ''),
(13, 201501, '', 27, 214564999, 0, '556677889900', 'Tesam Arifah', NULL, '', '2019-01-26', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Disini dikostan', 0, 0, '0899887766', NULL, NULL, NULL, 'tesam@26.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-07', 'admin', '::1', '0000-00-00', '', ''),
(14, 201501, '', 0, 41635201, 0, '13028888888892', 'TORIQ ', NULL, '', '2033-04-22', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'SUKABIRUS, PONDOK FIRDAUS A02', 0, 0, '082346890089', NULL, NULL, NULL, 'toriq@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-08', 'admin', '::1', '0000-00-00', '', ''),
(15, 201501, '', 0, 129571153, 0, '12345', 'Kaira', NULL, '', '2018-09-22', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl.Kemana Ya', 0, 0, '08123456', NULL, NULL, NULL, 'aaa@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-08', 'admin', '::1', '0000-00-00', '', ''),
(16, 201501, '1234567865432', 36, 87459488, 0, '1234567865432', 'intan', NULL, '', '2000-10-08', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'gba', 0, 0, '575573358998', NULL, NULL, NULL, 'intan@mail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-08', 'admin', '::1', '0000-00-00', '', ''),
(17, 201501, '', 30, 72171419, 0, '257473664663434', 'alsha', NULL, '', '2022-09-01', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'lacasa', 0, 0, '08675645565', NULL, NULL, NULL, 'alsha@mail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-08', 'admin', '::1', '0000-00-00', '', ''),
(18, 201501, '', 31, 45728998, 0, '15465543424', 'JACK DOE', NULL, '', '1989-07-05', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Soekarno Hatta No 123 Bandung Jawa Barat', 0, 0, '08673567434', NULL, NULL, NULL, 'jack@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-08', 'admin', '::1', '0000-00-00', '', ''),
(21, 201501, '', 34, 105027307, 0, '5436437466464765', 'Susi ', NULL, '', '2000-12-10', 0, 0, 'WANITA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jalan Selamet 10 sukabirus', 0, 0, '081233456789', NULL, NULL, NULL, 'susi@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-16', 'admin', '::1', '0000-00-00', '', ''),
(22, 201501, '', 0, 94107076, 0, '1234567890123456', 'Ruben Setiadi', NULL, '', '2000-10-08', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Bandung', 0, 0, '08126735896093', NULL, NULL, NULL, 'Ruse@mail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-16', 'admin', '::1', '0000-00-00', '', ''),
(23, 201501, '', 32, 45920433, 0, '3467892364823765', 'Rojak Saepudin Taufik', NULL, '', '2000-10-26', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 1, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Bandung', 0, 0, '081237544232596', NULL, NULL, NULL, 'Rosa@mail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-16', 'admin', '::1', '0000-00-00', '', ''),
(24, 201501, '', 33, 65132925, 0, '1671060511910006', 'M.ikhsan', NULL, '', '2022-09-01', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 1, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'jl.vetran', 0, 0, '081332565', NULL, NULL, NULL, 'nvdddjjmm@gmail.com', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-09-29', 'admin', '::1', '0000-00-00', '', ''),
(25, 201501, '', 0, 152334301, 0, '1003', 'Abizar (Inisial)', NULL, '', '2022-08-11', 0, 0, 'PRIA', '-', NULL, NULL, '-', '-', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 1, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '-', 0, 0, '081', NULL, NULL, NULL, '', '', 0, NULL, 'Anggota', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-01-25', 'admin', '::1', '0000-00-00', '', ''),
(26, 0, '', 0, 0, 0, '', 'Budi Krisnawan', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '13041110', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 0, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Raya', 'Jl. Raya', 33, 3304, '98198391231', NULL, NULL, NULL, 'budikrisnawan@telkom.id', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(27, 0, '', 0, 0, 0, '13019920', 'Nanda Prasetyo', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '13019920', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bebas Raya', 'Jl. Bebas Raya', 32, 3204, '0812938192', NULL, NULL, NULL, 'nandaprasetyo@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(28, 3, '', 43, 0, 0, '1301121', 'tester rpl', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '1301121', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Rahayu 23 Bandung', 'Jl. Rahayu 23 Bandung', 32, 3204, '0812938192', NULL, NULL, NULL, 'rpl1@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(29, 3, '', 44, 0, 0, '2901290131', 'rpl 2 bos', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '2901290131', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bebas Raya', 'Jl. Bebas Raya', 32, 3204, '08912893129', NULL, NULL, NULL, 'rpl2@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(30, 3, '', 45, 0, 0, '3023423', 'rpl 3 sih bos', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '3023423', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bedah Raya 390', 'Jl. Bedah Raya 390', 33, 3319, '1202190099', NULL, NULL, NULL, 'rpl3@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(31, 3, '', 46, 0, 0, '10293102', 'Rpl EMpat', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '10293102', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Reog', 'Jl. Reog', 33, 3304, '98198391231', NULL, NULL, NULL, 'rpl4@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(32, 3, '', 47, 0, 0, '022020', 'bandit', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '022020', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'jl', 'jl', 63, 6311, '0888888888', NULL, NULL, NULL, 'bandit@mail.com', '', 0, NULL, 'Programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(33, 0, '', 50, 0, 0, '91203129', 'susan', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '91203129', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bebas 17 Bandung', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', NULL, NULL, NULL, 'susan3@mail.com', '', 0, NULL, 'programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(34, 0, '', 51, 0, 0, '91203129', 'susan', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '91203129', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bebas 17 Bandung', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', NULL, NULL, NULL, 'susan4@mail.com', '', 0, NULL, 'programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '', '', '0000-00-00', '', ''),
(35, 0, '', 52, 0, 0, '91203129', 'susan', NULL, '', '0000-00-00', 0, 0, '', '-', NULL, NULL, '-', '-', '91203129', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', NULL, '', 2, 0, 'WNI', NULL, NULL, '0000-00-00', 'AKTIF', NULL, NULL, '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Jl. Bebas 17 Bandung', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', NULL, NULL, NULL, 'susan5@mail.com', '', 0, NULL, 'programmer', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', NULL, NULL, '', NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-08', '-10', '::1', '0000-00-00', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrm_perusahaan_asuransi`
--
...
--
-- Dumping data for table `hrm_perusahaan_asuransi`
--
...
CREATE TABLE `landing_home` (
  ...
  `type_landing` set('HEADER','CONTENT','FOOTER') NOT NULL,
  `is_active` int(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `landing_home` (`id_landing_home`, `page_number`, `page_name`, `source_html`, `type_landing`, `is_active`) VALUES
...
(90, 5, 'Header Page Default', '<head>\r\n  <meta charset=\"utf-8\">\r\n  <meta content=\"width=device-width, initial-scale=1.0\" name=\"viewport\">\r\n\r\n  <title>Sirana</title>\r\n  <meta content=\"\" name=\"description\">\r\n  <meta content=\"\" name=\"keywords\">\r\n\r\n  <!-- Favicons -->\r\n  <link href=\"assets/img/Only.png\" rel=\"icon\">\r\n  <!-- <link href=\"assets/img/apple-touch-icon.png\" rel=\"apple-touch-icon\"> -->\r\n\r\n  <!-- Google Fonts -->\r\n  <link rel=\"preconnect\" href=\"https://fonts.googleapis.com\">\r\n  <link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin>\r\n  <link href=\"https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=Poppins:ital,wght@0,300;0,400;0,500;0,600;0,700;1,300;1,400;1,500;1,600;1,700&family=Source+Sans+Pro:ital,wght@0,300;0,400;0,600;0,700;1,300;1,400;1,600;1,700&display=swap\" rel=\"stylesheet\">\r\n\r\n  <!-- Vendor CSS Files -->\r\n  <link href=\"assets/vendor/bootstrap/css/bootstrap.min.css\" rel=\"stylesheet\">\r\n  <link href=\"assets/vendor/bootstrap-icons/bootstrap-icons.css\" rel=\"stylesheet\">\r\n  <link href=\"assets/vendor/aos/aos.css\" rel=\"stylesheet\">\r\n  <link href=\"assets/vendor/glightbox/css/glightbox.min.css\" rel=\"stylesheet\">\r\n  <link href=\"assets/vendor/swiper/swiper-bundle.min.css\" rel=\"stylesheet\">\r\n\r\n  <!-- Variables CSS Files. Uncomment your preferred color scheme -->\r\n  <link href=\"assets/css/variables.css\" rel=\"stylesheet\">\r\n  <!-- <link href=\"assets/css/variables-blue.css\" rel=\"stylesheet\"> -->\r\n  <!-- <link href=\"assets/css/variables-green.css\" rel=\"stylesheet\"> -->\r\n  <!-- <link href=\"assets/css/variables-orange.css\" rel=\"stylesheet\"> -->\r\n  <!-- <link href=\"assets/css/variables-purple.css\" rel=\"stylesheet\"> -->\r\n  <!-- <link href=\"assets/css/variables-red.css\" rel=\"stylesheet\"> -->\r\n  <!-- <link href=\"assets/css/variables-pink.css\" rel=\"stylesheet\"> -->\r\n\r\n  <!-- Template Main CSS File -->\r\n  <link href=\"assets/css/main.css\" rel=\"stylesheet\">\r\n\r\n<link href=\"//netdna.bootstrapcdn.com/font-awesome/3.2.1/css/font-awesome.css\" rel=\"stylesheet\">\r\n  <!-- =======================================================\r\n  * Template Name: HeroBiz - v2.3.1\r\n  * Template URL: https://bootstrapmade.com/herobiz-bootstrap-business-template/\r\n  * Author: BootstrapMade.com\r\n  * License: https://bootstrapmade.com/license/\r\n  ======================================================== -->\r\n</head>\r\n<!-- ======= Header ======= -->\r\n  <header id=\"header\" class=\"header fixed-top\" data-scrollto-offset=\"0\">\r\n    <div class=\"container-fluid d-flex align-items-center justify-content-between\">\r\n\r\n      <a href=\"index.html\" class=\"logo d-flex align-items-center scrollto me-auto me-lg-0\">\r\n        <!-- Uncomment the line below if you also wish to use an image logo -->\r\n        <!-- <img src=\"assets/img/logo.png\" alt=\"\"> -->\r\n        <!-- <h1>HeroBiz<span>.</span></h1> -->\r\n        <img src=\"landing_asset/Horizontal.png\" alt=\"\">\r\n      </a>\r\n      <!-- <a href=\"index.html\" class=\"logo d-flex align-items-center scrollto me-auto me-lg-0\"> -->\r\n        <!-- Uncomment the line below if you also wish to use an image logo -->\r\n        <!-- <img src=\"assets/img/logo.png\" alt=\"\"> -->\r\n        <!-- <h1>Sirana<span>.</span></h1> -->\r\n      <!-- </a> -->\r\n\r\n      <nav id=\"navbar\" class=\"navbar\">\r\n        <ul>\r\n\r\n          <!-- <li><a href=\"index.html\"><span>Home</span></a>\r\n          </li> -->\r\n\r\n          <li><a class=\"nav-link scrollto\" href=\"index.html#about\">Tentang Kami</a></li>\r\n          <!-- <li><a class=\"nav-link scrollto\" href=\"index.html#services\">Services</a></li>\r\n          <li><a class=\"nav-link scrollto\" href=\"index.html#portfolio\">Portfolio</a></li>\r\n          <li><a class=\"nav-link scrollto\" href=\"index.html#team\">Team</a></li> -->\r\n          <!-- <li><a href=\"blog.html\">Blog</a></li>\r\n          <li class=\"dropdown megamenu\"><a href=\"#\"><span>Mega Menu</span> <i class=\"bi bi-chevron-down dropdown-indicator\"></i></a>\r\n            <ul>\r\n              <li>\r\n                <a href=\"#\">Column 1 link 1</a>\r\n                <a href=\"#\">Column 1 link 2</a>\r\n                <a href=\"#\">Column 1 link 3</a>\r\n              </li>\r\n              <li>\r\n                <a href=\"#\">Column 2 link 1</a>\r\n                <a href=\"#\">Column 2 link 2</a>\r\n                <a href=\"#\">Column 3 link 3</a>\r\n              </li>\r\n              <li>\r\n                <a href=\"#\">Column 3 link 1</a>\r\n                <a href=\"#\">Column 3 link 2</a>\r\n                <a href=\"#\">Column 3 link 3</a>\r\n              </li>\r\n              <li>\r\n                <a href=\"#\">Column 4 link 1</a>\r\n                <a href=\"#\">Column 4 link 2</a>\r\n                <a href=\"#\">Column 4 link 3</a>\r\n              </li>\r\n            </ul>\r\n          </li> -->\r\n          <!-- <li class=\"dropdown\"><a href=\"#\"><span>Drop Down</span> <i class=\"bi bi-chevron-down dropdown-indicator\"></i></a>\r\n            <ul>\r\n              <li><a href=\"#\">Drop Down 1</a></li>\r\n              <li class=\"dropdown\"><a href=\"#\"><span>Deep Drop Down</span> <i class=\"bi bi-chevron-down dropdown-indicator\"></i></a>\r\n                <ul>\r\n                  <li><a href=\"#\">Deep Drop Down 1</a></li>\r\n                  <li><a href=\"#\">Deep Drop Down 2</a></li>\r\n                  <li><a href=\"#\">Deep Drop Down 3</a></li>\r\n                  <li><a href=\"#\">Deep Drop Down 4</a></li>\r\n                  <li><a href=\"#\">Deep Drop Down 5</a></li>\r\n                </ul>\r\n              </li>\r\n              <li><a href=\"#\">Drop Down 2</a></li>\r\n              <li><a href=\"#\">Drop Down 3</a></li>\r\n              <li><a href=\"#\">Drop Down 4</a></li>\r\n            </ul>\r\n          </li>\r\n          <li><a class=\"nav-link scrollto\" href=\"index.html#contact\">Contact</a></li>\r\n        </ul>\r\n        <i class=\"bi bi-list mobile-nav-toggle d-none\"></i> -->\r\n      </nav><!-- .navbar -->\r\n\r\n      <a class=\"btn-getstarted scrollto\" href=\"administrator/\">Login</a>\r\n\r\n    </div>\r\n  </header><!-- End Header -->', 'HEADER', 0);
...
--
-- Table structure for table `mst_environment_attribute`
--
...
--
-- Table structure for table `mst_environment_attribute_grade`
--
...
--
-- Table structure for table `mst_jabatan_attribute`
--
...
--
-- Dumping data for table `mst_jabatan_attribute`
--
...
--
-- Table structure for table `mst_jabatan_attribute_grade`
--
...
--
-- Dumping data for table `mst_jabatan_attribute_grade`
--
...
--
-- Table structure for table `mst_jenis_penyakit`
--
...
--
-- Dumping data for table `mst_jenis_penyakit`
--
...
--
-- Table structure for table `mst_organization_attribute`
--
...
--
-- Table structure for table `mst_organization_attribute_grade`
--
...
--
-- Table structure for table `mst_personal_attribute`
--
...
--
-- Dumping data for table `mst_personal_attribute`
--
...
--
-- Table structure for table `mst_personal_attribute_grade`
--
...
--
-- Dumping data for table `mst_personal_attribute_grade`
--
...
(1, 1, 'PRIA', 1, NULL),
(2, 1, 'WANITA', 2, NULL),
(3, 2, 'PEKERJA MUDA (< 5 tahun)', 1, '0 - 5 tahun'),
(4, 2, 'PEKERJA MIDLE (5-10 tahun)', 2, '5-10 tahun masa kerja'),
(5, 2, 'PEKERJA SENIOR (Masa Kerja > 10 tahun)', 3, '(Masa Kerja > 10 tahun)'),
...
--
-- Table structure for table `mst_time_metric`
--

CREATE TABLE `mst_time_metric` (
  `id_time_metric` int(11) NOT NULL,
  `time_metric_id` varchar(200) NOT NULL,
  `time_metric_en` varchar(200) DEFAULT NULL,
  `description` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `mst_time_metric`
--

INSERT INTO `mst_time_metric` (`id_time_metric`, `time_metric_id`, `time_metric_en`, `description`) VALUES
(1, 'jam', 'hour', NULL),
(2, 'hari', 'day', NULL);
...
(1, 'TELKOM', NULL, '', NULL, NULL, NULL, 1, NULL, NULL, NULL),
(3, '2023 TELKOM UNIV RPL', '2l3-baf3', 'RPL 2023 Telkom University', 'Jl. Radio', '081902', 'email@mail.com', 1, NULL, NULL, NULL),
(4, '2021 Test', '3g4-122c', '', '', '', '', 1, NULL, NULL, NULL);
...
CREATE TABLE `product_backlog` (
  `id_product_backlog` bigint(20) NOT NULL,
  `id_project_mst_type` int(11) NOT NULL,
  `id_project` bigint(20) NOT NULL,
  `order_number` int(11) DEFAULT 0,
  `product_backlog` varchar(400) NOT NULL,
  `description` text DEFAULT NULL,
  `id_wiki_page` bigint(20) DEFAULT NULL,
  `external_information` varchar(250) DEFAULT NULL,
  `priority` int(11) DEFAULT 0,
  `load_estimatation` int(11) DEFAULT 0,
  `id_time_metric` int(11) DEFAULT 0,
  `id_sprint` bigint(20) DEFAULT 0,
  `is_multiple_sprint` int(1) NOT NULL DEFAULT 0,
  `id_sprint_mutliple` varchar(150) DEFAULT NULL,
  `progres_by_team` int(3) DEFAULT 0,
  `progres_by_owner` int(3) DEFAULT 0,
  `created_date` datetime DEFAULT NULL,
  `created_id_user` int(11) DEFAULT NULL,
  `created_ip_address` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `product_backlog` (`id_product_backlog`, `id_project_mst_type`, `id_project`, `order_number`, `product_backlog`, `description`, `id_wiki_page`, `external_information`, `priority`, `load_estimatation`, `id_time_metric`, `id_sprint`, `is_multiple_sprint`, `id_sprint_mutliple`, `progres_by_team`, `progres_by_owner`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 1, 0, 1, 'User bisa apa', NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, 0, '2023-04-02 14:15:39', NULL, NULL),
(2, 1, 1, 2, 'User bisa apa saja yang kedua', NULL, NULL, NULL, 0, 0, 0, 0, 0, NULL, 0, 0, '2023-04-02 14:17:25', NULL, NULL),
(3, 1, 3, 3, 'Testing saja', NULL, NULL, NULL, 1, 4, 5, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(4, 1, 3, 3, 'Testing saja', NULL, NULL, NULL, 1, 4, 5, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(5, 1, 11, 2, 'Sebagai User, Perusahaan dan admin, saya dapat melakukan Login', NULL, NULL, NULL, 1, 4, 2, 1005, 1, ';1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1005;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004', 100, 100, NULL, NULL, NULL),
(6, 1, 11, 3, 'Sebagai User, saya dapat melakukan pencarian pekerjaan', NULL, NULL, NULL, 4, 3, 2, 1005, 1, ';1004;1005;1004;1004;1004;1004;1004;1004;1005;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1005;1005', 77, 37, NULL, NULL, NULL),
(7, 1, 12, 1, 'Satu', NULL, NULL, NULL, 1, 20, NULL, 1001, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1002;1001;1001;1002', 27, 0, NULL, NULL, NULL),
(8, 1, 11, 1, 'Sebagai User dan Perusahaan, saya dapat melakukan Registrasi', NULL, NULL, NULL, 0, 3, 2, 0, 1, ';1004;1005;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004', 82, 15, NULL, NULL, NULL),
(10, 1, 11, 5, 'Sebagai User, saya dapat melakukan Upload Data', NULL, NULL, NULL, 1, 3, 2, 1005, 1, ';1004;1005;1005;1005', 73, 44, NULL, NULL, NULL),
(12, 1, 11, 4, 'Sebagai User dan Perusahaan, saya dapat melakukan  logout', NULL, NULL, NULL, 4, 5, 2, 1004, 1, ';1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004', 60, 0, NULL, NULL, NULL),
(14, 1, 11, 6, 'Sebagai User dan Perusahaan, saya dapat melihat halaman Dashboard', NULL, NULL, NULL, 0, 2, 2, 1005, 1, ';1005;1005;1005', 53, 56, NULL, NULL, NULL),
(15, 1, 11, 7, 'Sebagai User, saya dapat melihat  Detail Pekerjaan', NULL, NULL, NULL, 1, 3, 2, 1005, 1, ';1004;1004;1004;1004;1004;1004;1004;1004;1005;1005;1005', 30, 61, NULL, NULL, NULL),
(16, 1, 11, 8, 'Sebagai Admin, saya dapat melihat dashboard', NULL, NULL, NULL, 3, 3, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(17, 1, 11, 9, 'Sebagai User, Perusahaan dan admin, saya dapat melakukan Belum', NULL, NULL, NULL, 0, 4, 2, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(18, 1, 11, 10, 'Sepuluh', NULL, NULL, NULL, 0, 4, 2, 1004, 1, ';1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004;1004', 0, 0, NULL, NULL, NULL),
(19, 1, 12, 2, 'Dua', NULL, NULL, NULL, 0, 0, NULL, 1001, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1002', 44, 0, NULL, NULL, NULL),
(21, 1, 12, 3, 'Tiga', NULL, NULL, NULL, 0, 0, NULL, 1001, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001', 33, 0, NULL, NULL, NULL),
(22, 1, 12, 4, 'Empat', NULL, NULL, NULL, 0, 0, NULL, 1002, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002', 0, 0, NULL, NULL, NULL),
(23, 1, 12, 5, 'lima', NULL, NULL, NULL, 0, 0, NULL, 1001, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001;1001', 41, 0, NULL, NULL, NULL),
(24, 1, 12, 6, 'enam', NULL, NULL, NULL, 0, 0, NULL, 1002, 1, ';1001;1001;1001;1001;1001;1001;1001;1001;1001;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002', 0, 0, NULL, NULL, NULL),
(25, 1, 12, 7, 'tujuh', NULL, NULL, NULL, 0, 0, NULL, 1002, 1, ';1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002', 0, 0, NULL, NULL, NULL),
(26, 1, 12, 8, 'Delapan', NULL, NULL, NULL, 0, 0, NULL, 1002, 1, ';1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002;1002', 0, 0, NULL, NULL, NULL),
(27, 1, 12, 9, 'Sembilan', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(28, 1, 12, 10, 'Sepuluh', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(29, 1, 12, 11, 'Sebelas', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(30, 1, 12, 12, 'Dua belas', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(31, 1, 12, 13, 'Tiga belas', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(32, 1, 12, 14, 'Empat Belas', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL),
(33, 1, 12, 15, 'Lima Belas', NULL, NULL, NULL, 0, 0, NULL, 0, 0, NULL, 0, 0, NULL, NULL, NULL);
...
CREATE TABLE `project` (
  ...
  `id_perusahaan` bigint(20) NOT NULL,
  `id_project_mst_type` int(11) NOT NULL,
  `kode_proyek` varchar(60) DEFAULT NULL,
  `nama_proyek` varchar(170) NOT NULL,
  `description` text DEFAULT NULL,
  `is_active` int(1) NOT NULL,
  `backlog_is_locked` int(1) NOT NULL DEFAULT 0,
  `repo_code` varchar(250) DEFAULT NULL,
  `repo1` varchar(250) DEFAULT NULL,
  `repo2` varchar(250) DEFAULT NULL,
  `repo3` varchar(250) DEFAULT NULL,
  `repo4` varchar(250) DEFAULT NULL,
  `repo5` varchar(250) DEFAULT NULL,
  `repo6` varchar(250) DEFAULT NULL,
...
INSERT INTO `project` (`id_project`, `id_perusahaan`, `id_project_mst_type`, `kode_proyek`, `nama_proyek`, `description`, `is_active`, `backlog_is_locked`, `repo_code`, `repo1`, `repo2`, `repo3`, `repo4`, `repo5`, `repo6`, `plan_start_date`, `plan_end_date`, `actual_start_date`, `actual_end_date`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(3, 3, 1, '0-d41d', 'Proyek Testing', 'DSASDAS\r\n', 1, 1, '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 3, 1, '', 'Proyek Testing', 'sdfgh', 1, 1, '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 3, 1, '1rc-e4da', 'wasdas', 'asdas', 1, 1, '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 3, 1, '240-1679', 'Proyek Testing', 'asdasd', 1, 1, 'asd', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', NULL, NULL, NULL, NULL, NULL),
(7, 3, 1, '2go-8f14', 'Proyek Nama', 'asd', 1, 1, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 3, 1, '2tc-c9f0', 'jasjdajsd', '', 1, 1, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 3, 1, '360-45c4', 'alsdlasdkas', '', 1, 1, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 3, 1, '3io-d3d9', 'Proyek Apa saja', 'Deskripsi', 1, 1, 'Repositoriy', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', NULL, NULL, NULL, NULL, NULL),
(11, 3, 1, '3vc-6512', 'Aplikasi Ekspor Impor', 'Aplikasi untuk melakukan pencatatan proses ekspor dan impor.', 1, 0, 'asd', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 3, 1, '480-c20a', 'Aplikasi Peminjaman Buku', 'Sistem informasi aplikasi peminjaman buku', 0, 1, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, 3, 1, '4ko-c51c', 'Aplikasi Pelaporan Desa', 'Aplikasi untuk melaporkan kegiatan-kegiatan desa yang diperlukan bagi kepala desa dan masyarakat desa.', 1, 1, 'asd', NULL, NULL, NULL, NULL, NULL, NULL, '0000-00-00', '0000-00-00', NULL, NULL, NULL, NULL, NULL),
(14, 3, 1, '4xc-aab3', 'Aplikasi Deteksi Wajah', 'Contoh proyek aplikasi deteksi wajah', 1, 1, 'github link', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 3, 1, '5a0-9bf3', 'Proyek Testing', 'ss', 1, 1, 's', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-19', '2023-04-13', NULL, NULL, NULL, NULL, NULL),
(16, 3, 1, '5mo-c74d', 'sa', 'sda', 1, 1, 'asda', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-19', '2023-04-13', NULL, NULL, NULL, NULL, NULL),
(17, 3, 1, '5zc-70ef', 'sa', 'sda', 1, 1, 'asda', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-19', '2023-04-13', NULL, NULL, NULL, NULL, NULL),
(18, 3, 1, '6c0-6f49', 'sa', 'sda', 1, 1, 'asda', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-19', '2023-04-13', NULL, NULL, NULL, NULL, NULL),
(19, 3, 1, '6oo-1f0e', 'as', 'sad', 1, 1, 'asd', NULL, NULL, NULL, NULL, NULL, NULL, '2023-04-25', '2023-04-05', NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `project_member` (
  `id_project_member` bigint(20) NOT NULL,
  `id_project` bigint(20) NOT NULL,
  `id_pegawai` bigint(20) NOT NULL,
  `id_project_mst_role` int(11) NOT NULL,
...
INSERT INTO `project_member` (`id_project_member`, `id_project`, `id_pegawai`, `id_project_mst_role`, `start_date`, `end_date`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 9, 43, 102, NULL, NULL, NULL, NULL, NULL),
(2, 10, 43, 102, '0000-00-00', '0000-00-00', NULL, NULL, NULL),
(3, 11, 28, 101, NULL, NULL, NULL, NULL, NULL),
(4, 12, 28, 102, NULL, NULL, NULL, NULL, NULL),
(5, 13, 28, 102, '0000-00-00', '0000-00-00', NULL, NULL, NULL),
(6, 11, 29, 102, NULL, NULL, NULL, NULL, NULL),
(7, 13, 29, 102, '0000-00-00', '0000-00-00', NULL, NULL, NULL),
(8, 12, 29, 102, NULL, NULL, NULL, NULL, NULL),
(9, 14, 28, 102, NULL, NULL, NULL, NULL, NULL),
(10, 14, 29, 203, NULL, NULL, NULL, NULL, NULL),
(11, 15, 31, 102, '2023-04-19', '2023-04-13', NULL, NULL, NULL),
(12, 16, 31, 102, '2023-04-19', '2023-04-13', NULL, NULL, NULL),
(13, 17, 31, 102, '2023-04-19', '2023-04-13', NULL, NULL, NULL),
(14, 18, 31, 102, '2023-04-19', '2023-04-13', NULL, NULL, NULL),
(15, 19, 29, 102, '2023-04-25', '2023-04-05', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `project_mst_role`
--

CREATE TABLE `project_mst_role` (
  `id_project_mst_role` int(11) NOT NULL,
  `id_project_mst_type` int(11) NOT NULL,
  `role_name` varchar(250) NOT NULL,
  `icon` varchar(250) DEFAULT NULL,
  `color_style` varchar(250) DEFAULT NULL,
  `is_active` int(1) NOT NULL DEFAULT 1,
  `description` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `project_mst_role`
--

INSERT INTO `project_mst_role` (`id_project_mst_role`, `id_project_mst_type`, `role_name`, `icon`, `color_style`, `is_active`, `description`) VALUES
(101, 1, 'PRODUCT OWNER', NULL, 'bg-red', 1, NULL),
(102, 1, 'SCRUM MASTER', NULL, 'bg-green', 1, NULL),
(103, 1, 'SCRUM MEMBER', NULL, 'bg-blue', 1, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `project_mst_type`
--

CREATE TABLE `project_mst_type` (
  `id_project_mst_type` int(11) NOT NULL,
...
--
-- Dumping data for table `project_mst_type`
--

INSERT INTO `project_mst_type` (`id_project_mst_type`, `project_type`, `deskripsi`, `is_active`) VALUES
(1, 'SCRUM', NULL, 1),
(2, 'KANBAN S-CURVE', NULL, 1);
...
--
-- Table structure for table `pro_environment_attribute`
--
...
--
-- Table structure for table `pro_jabatan_attribute`
--
...
--
-- Table structure for table `pro_organization_attribute`
--
...
--
-- Table structure for table `pro_personal_attribute`
--
...
--
-- Dumping data for table `pro_personal_attribute`
--
...
(1, 3, 2, 3, '2022-12-26 03:56:14', 1, '1:1:1'),
(2, 7, 1, 1, NULL, NULL, NULL),
(3, 7, 2, 4, NULL, NULL, NULL),
(4, 7, 3, 7, NULL, NULL, NULL),
(5, 3, 1, 1, NULL, NULL, NULL),
(6, 3, 3, 6, NULL, NULL, NULL),
(7, 4, 1, 2, NULL, NULL, NULL),
(8, 4, 2, 3, NULL, NULL, NULL),
(9, 4, 3, 7, NULL, NULL, NULL),
(10, 25, 1, 1, NULL, NULL, NULL),
(11, 25, 2, 3, NULL, NULL, NULL),
(12, 25, 3, 6, NULL, NULL, NULL),
(13, 1, 1, 1, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `publik_user`
--

CREATE TABLE `publik_user` (
  `id_publik_user` bigint(20) NOT NULL,
  `nama` varchar(250) NOT NULL,
  `jenis_user` set('PERORANGAN','PERUSAHAAN') NOT NULL,
  ...
  `file_identitas` varchar(250) NOT NULL,
  `file_akta_pendirian` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `publik_user`
--

INSERT INTO `publik_user` (`id_publik_user`, `nama`, `jenis_user`, `nik`, `pekerjaan`, `alamat`, `id_propinsi`, `id_kabupaten`, `nomor_telepon`, `email`, `id_user`, `file_identitas`, `file_akta_pendirian`) VALUES
(3, 'Maria', 'PERORANGAN', '82912', 'mahasiswa', 'Jl. Riau 27 Bandung', 15, 1105, '08129183', 'maria@gmail.com', 100, '--upload belum bisa--', ''),
(132, 'ananda', 'PERORANGAN', '1829310239102391', 'Swasta', 'Jl.Bebas', 36, 5103, '0812938192', 'nanda2@mail.com', -1, 'flashscreen1.png', NULL),
(133, 'ananda', 'PERORANGAN', '1829310239102391', 'Swasta', 'Jl.Bebas', 65, 5103, '0812938192', 'tester@mail.com', 37, 'Illustration-Copy.png', NULL),
(134, 'ananda', 'PERORANGAN', '1829310239102391', 'Swasta', 'Jl.Bebas', 65, 1208, '08912893129', 'testerdudu@mail.com', 38, '--', '--'),
(135, 'ananda', 'PERORANGAN', '1829310239102391', 'Swasta', 'Jl.Bebas', 32, 3204, '0812938192', 'ananda@mail.com', 39, '--', '--'),
(136, 'Budi Krisnawan', 'PERORANGAN', '13041110', 'Programmer', 'Jl. Raya', 33, 3304, '98198391231', 'budi@telkom.id', 40, '--', '--'),
(137, 'Budi Krisnawan', 'PERORANGAN', '13041110', 'Programmer', 'Jl. Raya', 33, 3304, '98198391231', 'budikrisnawan@telkom.id', 41, '--', '--'),
(138, 'Nanda Prasetyo', 'PERORANGAN', '13019920', 'Programmer', 'Jl. Bebas Raya', 32, 3204, '0812938192', 'nandaprasetyo@mail.com', 42, '--', '--'),
(139, 'tester rpl', 'PERORANGAN', '1301121', 'Programmer', 'Jl. Rahayu 23 Bandung', 32, 3204, '0812938192', 'rpl1@mail.com', 43, '--', '--'),
(140, 'rpl 2 bos', 'PERORANGAN', '2901290131', 'Programmer', 'Jl. Bebas Raya', 32, 3204, '08912893129', 'rpl2@mail.com', 44, '--', '--'),
(141, 'rpl 3 sih bos', 'PERORANGAN', '3023423', 'Programmer', 'Jl. Bedah Raya 390', 33, 3319, '1202190099', 'rpl3@mail.com', 45, '--', '--'),
(142, 'Rpl EMpat', 'PERORANGAN', '10293102', 'Programmer', 'Jl. Reog', 33, 3304, '98198391231', 'rpl4@mail.com', 46, '--', '--'),
(143, 'bandit', 'PERORANGAN', '022020', 'Programmer', 'jl', 63, 6311, '0888888888', 'bandit@mail.com', 47, '--', '--'),
(144, 'susan', 'PERORANGAN', '91203129', 'programmer', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', 'susan@mail.com', 48, '--', '--'),
(145, 'susan', 'PERORANGAN', '91203129', 'programmer', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', 'susan2@mail.com', 49, '--', '--'),
(146, 'susan', 'PERORANGAN', '91203129', 'programmer', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', 'susan3@mail.com', 50, '--', '--'),
(147, 'susan', 'PERORANGAN', '91203129', 'programmer', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', 'susan4@mail.com', 51, '--', '--'),
(148, 'susan', 'PERORANGAN', '91203129', 'programmer', 'Jl. Bebas 17 Bandung', 33, 3304, '08912893129', 'susan5@mail.com', 52, '--', '--');
...
--
-- Table structure for table `scrum_daily`
--

CREATE TABLE `scrum_daily` (
  `id_scrum_daily` bigint(20) NOT NULL,
  `id_project` int(11) NOT NULL,
  `id_sprint` int(11) NOT NULL,
  `id_pegawai` int(11) NOT NULL,
  `standup_date` date NOT NULL,
  `yesterday_todo` varchar(400) DEFAULT NULL,
  `today_todo` varchar(400) NOT NULL,
  `obstacle` varchar(400) DEFAULT NULL,
  `yesterday_bukti` varchar(250) DEFAULT NULL,
...
--
-- Dumping data for table `scrum_daily`
--

INSERT INTO `scrum_daily` (`id_scrum_daily`, `id_project`, `id_sprint`, `id_pegawai`, `standup_date`, `yesterday_todo`, `today_todo`, `obstacle`, `yesterday_bukti`, `status`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(3, 11, 1005, 28, '2023-04-01', 'ba', 'sa', 'sdasda', NULL, 2, NULL, NULL, NULL),
(4, 11, 1005, 28, '2023-04-05', 'Selain itu, anggota Direksi dan Dewan Komisaris/Dewan Pengawas BUMN juga akan menerima insentif. Berikut rinciannya:  1. Wakil direktur utama BUMN sebesar 90 persen dari direktur utama BUMN 2. Anggota Direksi BUMN sebesar 85 persen dari direktur utama BUMN 3. Komisaris utama/ketua Dewan Pengawas BUM', 'Lalu, gaji komisaris utama atau ketua Dewan Pengawas BUMN adalah 45% dari gaji direktur utama. Dan wakil komisaris utama atau wakil ketua dewan pengawas sebesar 42,5%.  Selanjutnya dewan komisaris atau dewan pengawas BUMN mendapatkan gaji 90% dari gaji komisaris utama atau ketua dewan pengawas BUMN.', 'Menteri BUMN Erick Thohir memangkas gaji wakil direktur utama BUMN sebesar 5%. Kebijakan ini diatur lewat Peraturan Menteri (Permen) BUMN Nomor 3 Tahun 2023 tentang Organ dan Sumber Daya Manusia BUMN. Dalam Permen tersebut, disebutkan gaji wakil direktur utama BUMN sebesar 90% dari gaji direktur uta', NULL, 2, NULL, NULL, NULL),
(5, 11, 1005, 29, '2023-04-03', 'Taman Mini Indonesia Indah (TMII) bakal dibuka secara resmi tanggal 17 Agustus 2023. Hal ini diumumkan langsung Wakil Menteri Badan Usaha Milik Negara (BUMN) Kartika Wirjoatmodjo. \"Nantikan 17 Agustus 2023. Grand Reopening Taman Mini Indonesia Indah,\" katanya di akun Instagram pribadinya @tiko1973, ', '\"Dengan peluncuran ulang wahana-wahana utama, seperti: Keong Mas, Museum Indonesia, Taman Komodo, Taman Burung, Aquarium Air Tawar, Kereta Gantung, Aeromovel,\" lanjut Tiko.  Taman Mini Indonesia Indah (TMII) adalah salah satu kawasan taman wisata yang bertema budaya Indonesia di daerah Jakarta Timur', 'Dalam catatan detikcom, Taman Mini Indonesia Indah (TMII) sempat melakukan penutupan untuk umum karena revitalisasi sejak 17 Mei 2022. Namun ternyata revitalisasi sudah dilakukan sejak Januari 2022.  Selama proses revitalisasi berbagai wahana dan fasilitas dibenahi mulai dari penanganan jalan, penat', NULL, 2, NULL, NULL, NULL),
(6, 11, 1005, 29, '2023-04-05', 'Konstruksi Eco Green Parking Building yang digunakan untuk tempat parkir para tamu-tamu Presidensi G20 ditarget rampung pada 31 September 2022 mendatang, atau lebih cepat 3 bulan dari target waktu pengerjaan. Untuk diketahui, kontrak pekerjaan telah ditandatangani awal tahun lalu di Gedung Kementeri', 'Kemudian gedung parkir juga menerapkan sistem recycling untuk air hujan, di mana air hujan akan masuk dan disimpan di toren atau penyimpanan air, yang kemudian digunakan untuk flushing dan menyiram tanaman. Ada juga landscape bangunan pada gedung ini yang akan ditanami 124 pohon.  Sejak dimulai kons', 'Selain itu, Eco Green Building Parking memiliki luas bangunan 25.736,3 meter di atas tanah seluas 22,147 meter. Gedung ini juga dilengkapi dengan 1 basement dan terdiri dari 3 lantai. Gedung ini nantinya mampu menampung 1.026 kendaraan di antaranya 20 slot parkir untuk bus, 578 untuk mobil, 364 untu', NULL, 2, NULL, NULL, NULL),
(7, 11, 1005, 28, '2023-04-02', 'ebasnya mantan Ketum Partai Demokrat (PD) Anas Urbaningrum dari jeruji Lapas Sukamiskin tinggal menghitung hari. Dia pun akan berstatus cuti ketika keluar nanti.\nJadwal bebasnya Anas Urbaningrum dari Lapas Sukamiskin diundur. Sebelumnya Anas dijadwalkan bebas dari bui pada 10 April, tapi diundur menjadi 11 April.\n\n\"Betul (mundur), karena administrasi aja,\" ujar Kadivpas Kemenkumham Jabar Kusnali k', '\"Kami nggak ada pengamanan khusus pada saat pembebasan Pak Anas Urbaningrum,\" katanya.\n\nSementara itu, jadwal mundurnya kebebasan Anas juga dikatakan loyalis Anas. Para loyalis Anas sudah menyiapkan penjemputan.\n\n\"Bahwa pembebasan Anas Urbaningrum yang direncanakan pada 10 April 2023 jam 14.00 WIB, mundur menjadi tanggal 11 April 2023 jam 14.00 WIB,\" kata Kornas Sahabat Anas Urbaningrum, Muhammad ', 'Barcelona - Real Madrid ke final Copa del Rey usai mencukur Barcelona 4-0 di Camp Nou. Karim Benzema mencetak hat-trick dalam kemenangan ini.\nLaga Barcelona vs Real Madrid pada semifinal leg kedua Copa del Rey berlangsung di Camp Nou, Kamis (6/4/2023) dini hari WIB. Barca masuk lapangan dalam posisi unggul 1-0.\n\nBarca memulai dengan positif, tapi Madrid memanfaatkan peluangnya di akhir babak perta', NULL, 2, NULL, NULL, NULL),
(9, 11, 1005, 29, '2023-04-06', 'ss', 'sda', 'asdas', NULL, 2, NULL, NULL, NULL),
(10, 11, 1005, 28, '2023-04-06', 'ba', 'sdas', 'asdasdas', NULL, 2, NULL, NULL, NULL),
(11, 11, 1004, 28, '2023-04-06', 'apa saja yang bagus', 'sudah bagus', 'Sudah bagus sekali', NULL, 2, NULL, NULL, NULL),
(12, 11, 1005, 30, '2023-04-15', 'baba', 'testing', 'aslsda', NULL, 2, NULL, NULL, NULL),
(13, 11, 1005, 28, '2023-04-15', 'Waw ok sekali', '-', '-', NULL, 1, NULL, NULL, NULL),
(14, 11, 1005, 28, '2023-04-16', 'Progres yang sangat bagus', '', NULL, NULL, 1, NULL, NULL, NULL),
(15, 11, 1005, 28, '2023-04-17', 'Hari ini saya sudah membuat report yang bagus loh', 'Hari ini saya mau apa ya...', 'kendala apa saja yang terjadi di hari ini yang bisa dilihat dan diceklist', NULL, 2, NULL, NULL, NULL),
(16, 11, 1005, 29, '2023-04-17', 'Asoi bos', 'Rencana kerja hari ini terkait dengan kegiatan nomor berapa ya', 'Sudah selesai', NULL, 2, NULL, NULL, NULL),
(17, 11, 1005, 29, '2023-04-20', 'ssss', '', NULL, NULL, 1, NULL, NULL, NULL),
(18, 11, 1005, 28, '2023-04-20', 'dfghjk', 'fghjk', '', NULL, 2, NULL, NULL, NULL),
(19, 11, 1004, 28, '2023-04-22', 'Apa sjaa deh ya elah', 'Rencana aja', NULL, NULL, 1, NULL, NULL, NULL),
(20, 11, 1005, 28, '2023-04-26', 'Saya udah ubah jadi selesai', '', NULL, NULL, 1, NULL, NULL, NULL),
(21, 12, 1001, 28, '2023-04-26', 'ssda', '', NULL, NULL, 1, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `scrum_daily_for_now`
--

CREATE TABLE `scrum_daily_for_now` (
  `id_scrum_daily_for_now` int(11) NOT NULL,
  `id_scrum_daily` int(11) NOT NULL,
  `id_sprint` bigint(20) NOT NULL,
  `id_pegawai` bigint(20) NOT NULL,
  `id_project` bigint(20) NOT NULL,
  `id_product_backlog` int(11) NOT NULL,
  `target` int(3) NOT NULL,
  `kontribusi` int(3) NOT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_id_user` int(11) DEFAULT NULL,
  `created_ip_address` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `scrum_daily_for_now`
--

INSERT INTO `scrum_daily_for_now` (`id_scrum_daily_for_now`, `id_scrum_daily`, `id_sprint`, `id_pegawai`, `id_project`, `id_product_backlog`, `target`, `kontribusi`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 15, 1005, 28, 11, 8, 82, 45, NULL, NULL, NULL),
(2, 15, 1005, 28, 11, 15, 15, 15, NULL, NULL, NULL),
(3, 15, 1005, 28, 11, 14, 100, 82, NULL, NULL, NULL),
(4, 16, 1005, 29, 11, 8, 43, 6, NULL, NULL, NULL),
(5, 16, 1005, 29, 11, 12, 49, 20, NULL, NULL, NULL),
(6, 18, 1005, 28, 11, 8, 83, 9, NULL, NULL, NULL),
(7, 18, 1005, 28, 11, 5, 74, 30, NULL, NULL, NULL),
(8, 19, 1004, 28, 11, 8, 90, 8, NULL, NULL, NULL),
(9, 19, 1004, 28, 11, 6, 86, 9, NULL, NULL, NULL),
(10, 19, 1004, 28, 11, 15, 50, 20, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `scrum_daily_for_yesterday`
--

CREATE TABLE `scrum_daily_for_yesterday` (
  `id_scrum_daily_for_yesterday` int(11) NOT NULL,
  `id_scrum_daily` int(11) NOT NULL,
  `id_sprint` bigint(20) NOT NULL DEFAULT 0,
  `id_pegawai` bigint(20) NOT NULL,
  `id_project` bigint(20) NOT NULL DEFAULT 0,
  `id_product_backlog` int(11) NOT NULL,
  `progres` int(3) NOT NULL,
  `progres_previous` int(3) NOT NULL DEFAULT 0,
  `kontribusi` int(3) NOT NULL DEFAULT 0,
  `created_date` datetime DEFAULT NULL,
  `created_id_user` int(11) DEFAULT NULL,
  `created_ip_address` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `scrum_daily_for_yesterday`
--

INSERT INTO `scrum_daily_for_yesterday` (`id_scrum_daily_for_yesterday`, `id_scrum_daily`, `id_sprint`, `id_pegawai`, `id_project`, `id_product_backlog`, `progres`, `progres_previous`, `kontribusi`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 13, 1005, 28, 11, 5, 31, 0, 31, NULL, NULL, NULL),
(2, 13, 1005, 28, 11, 6, 64, 76, -12, NULL, NULL, NULL),
(3, 13, 1005, 28, 11, 10, 70, 56, 14, NULL, NULL, NULL),
(4, 13, 1005, 28, 11, 12, 38, 0, 38, NULL, NULL, NULL),
(5, 13, 1005, 28, 11, 8, 60, 51, 9, NULL, NULL, NULL),
(22, 14, 1005, 28, 11, 10, 56, 56, 25, NULL, NULL, NULL),
(29, 14, 1005, 28, 11, 14, 53, 53, 53, NULL, NULL, NULL),
(31, 14, 1005, 28, 11, 8, 37, 37, 0, NULL, NULL, NULL),
(32, 15, 1005, 28, 11, 5, 27, 27, 15, NULL, NULL, NULL),
(33, 15, 1005, 28, 11, 12, 29, 29, 29, NULL, NULL, NULL),
(34, 16, 1005, 29, 11, 5, 27, 27, 12, NULL, NULL, NULL),
(35, 16, 1005, 29, 11, 10, 73, 73, 17, NULL, NULL, NULL),
(36, 17, 1005, 29, 11, 8, 64, 61, 27, NULL, NULL, NULL),
(37, 17, 1005, 29, 11, 12, 60, 59, 31, NULL, NULL, NULL),
(38, 17, 1005, 29, 11, 5, 44, 43, 17, NULL, NULL, NULL),
(39, 18, 1005, 28, 11, 8, 74, 74, 10, NULL, NULL, NULL),
(40, 18, 1005, 28, 11, 6, 70, 70, 19, NULL, NULL, NULL),
(41, 19, 1004, 28, 11, 8, 82, 82, 8, NULL, NULL, NULL),
(42, 19, 1004, 28, 11, 6, 77, 77, 7, NULL, NULL, NULL),
(43, 19, 1004, 28, 11, 15, 30, 30, 30, NULL, NULL, NULL),
(44, 20, 1005, 28, 11, 5, 100, 44, 56, NULL, NULL, NULL),
(45, 21, 1001, 28, 12, 21, 33, 33, 33, NULL, NULL, NULL),
(46, 21, 1001, 28, 12, 23, 41, 41, 41, NULL, NULL, NULL),
(47, 21, 1001, 28, 12, 7, 27, 0, 27, NULL, NULL, NULL),
(48, 21, 1001, 28, 12, 19, 44, 0, 44, NULL, NULL, NULL);
...
CREATE TABLE `sprint` (
  ...
  `sprint_code` varchar(30) DEFAULT NULL,
  `duration_in_week` int(11) DEFAULT NULL,
  `start_date` date DEFAULT NULL,
  `end_date` date DEFAULT NULL,
...
INSERT INTO `sprint` (`id_sprint`, `id_project`, `sprint_number`, `sprint_code`, `duration_in_week`, `start_date`, `end_date`, `note`, `is_active`, `is_locked`, `is_closed`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1001, 12, 11, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, NULL, NULL, NULL),
(1002, 12, 12, NULL, NULL, '0000-00-00', '0000-00-00', NULL, 0, 0, 0, NULL, NULL, NULL),
(1004, 11, 2, NULL, NULL, '2023-04-20', '2023-04-20', NULL, 0, 0, 0, NULL, NULL, NULL),
(1005, 11, 1, NULL, NULL, '2023-04-12', '2023-04-21', NULL, 0, 0, 0, NULL, NULL, NULL),
(1006, 11, 3, NULL, NULL, '2023-04-12', '2023-04-29', NULL, 0, 0, 0, NULL, NULL, NULL),
(1008, 12, 13, NULL, NULL, '2023-04-18', '2023-04-26', NULL, 0, 0, 0, NULL, NULL, NULL);
...
CREATE TABLE `sprint_backlog` (
  `id_sprint_backlog` bigint(20) NOT NULL,
  `id_project` bigint(20) NOT NULL,
  `id_sprint` bigint(20) NOT NULL,
  `id_product_backlog` bigint(20) NOT NULL,
  `start_work` date DEFAULT NULL,
  `end_work` date DEFAULT NULL,
  `last_contribute_user` int(11) DEFAULT 0,
  `total_duration` int(11) DEFAULT 0,
  `id_time_metric` int(11) DEFAULT 0,
  `last_progres_by_team` int(3) NOT NULL DEFAULT 0,
  `last_progres_by_owner` int(3) NOT NULL DEFAULT 0,
  `created_date` datetime DEFAULT NULL,
  `created_id_user` int(11) DEFAULT NULL,
  `created_ip_address` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `sprint_backlog` (`id_sprint_backlog`, `id_project`, `id_sprint`, `id_product_backlog`, `start_work`, `end_work`, `last_contribute_user`, `total_duration`, `id_time_metric`, `last_progres_by_team`, `last_progres_by_owner`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(33, 11, 1005, 5, '2023-04-26', '2023-04-26', 28, 0, 0, 100, 100, '2023-04-20 19:23:22', 43, '::1'),
(34, 11, 1005, 6, '2023-04-20', '2023-04-20', 28, 0, 0, 77, 37, '2023-04-20 19:23:22', 43, '::1'),
(35, 11, 1005, 10, NULL, NULL, 0, 0, 0, 73, 44, '2023-04-20 19:23:22', 43, '::1'),
(36, 11, 1005, 14, NULL, NULL, 0, 0, 0, 53, 56, '2023-04-20 19:23:22', 43, '::1'),
(37, 11, 1005, 15, NULL, NULL, 0, 0, 0, 30, 61, '2023-04-20 19:23:22', 43, '::1'),
(44, 11, 1004, 18, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-24 08:39:57', 43, '::1'),
(48, 11, 1004, 6, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-24 21:09:43', 43, '::1'),
(49, 11, 1004, 5, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 10:24:56', 43, '::1'),
(50, 11, 1004, 12, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 10:44:42', 43, '::1'),
(51, 11, 1004, 8, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 10:45:33', 43, '::1'),
(53, 12, 1001, 21, '2023-04-26', '2023-04-26', 28, 0, 0, 33, 0, '2023-04-26 10:51:18', 43, '::1'),
(54, 12, 1001, 23, '2023-04-26', '2023-04-26', 28, 0, 0, 41, 0, '2023-04-26 10:51:18', 43, '::1'),
(55, 12, 1001, 7, '2023-04-26', '2023-04-26', 28, 0, 0, 27, 0, '2023-04-26 10:57:34', 43, '::1'),
(56, 12, 1001, 19, '2023-04-26', '2023-04-26', 28, 0, 0, 44, 0, '2023-04-26 11:30:47', 43, '::1'),
(67, 12, 1002, 19, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 12:43:31', 43, '::1'),
(68, 12, 1002, 24, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 12:43:31', 43, '::1'),
(69, 12, 1002, 25, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 12:43:31', 43, '::1'),
(70, 12, 1002, 26, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 12:43:31', 43, '::1'),
(73, 12, 1002, 22, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 14:24:35', 43, '::1'),
(75, 12, 1002, 7, NULL, NULL, 0, 0, 0, 0, 0, '2023-04-26 14:55:31', 43, '::1');

-- --------------------------------------------------------

--
-- Table structure for table `sprint_ceremony`
--

CREATE TABLE `sprint_ceremony` (
  `id_sprint_ceremony` bigint(20) NOT NULL,
  `id_project` bigint(20) NOT NULL,
  `id_sprint` bigint(20) NOT NULL,
  `ceremony` set('PLANNING','REVIEW','RETROSPECTIVE') NOT NULL,
  `ceremony_date` date DEFAULT NULL,
  `noted` text NOT NULL,
  `external_notes1` varchar(300) DEFAULT NULL,
  `external_notes2` varchar(300) DEFAULT NULL,
  `external_notes3` varchar(300) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `created_id_user` int(11) DEFAULT NULL,
  `created_ip_address` varchar(64) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Dumping data for table `sprint_ceremony`
--

INSERT INTO `sprint_ceremony` (`id_sprint_ceremony`, `id_project`, `id_sprint`, `ceremony`, `ceremony_date`, `noted`, `external_notes1`, `external_notes2`, `external_notes3`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 11, 1005, 'PLANNING', NULL, 'Ini catatan untuk planning ya', NULL, NULL, NULL, '2023-04-26 10:47:42', 43, '::1'),
(2, 11, 1004, 'PLANNING', NULL, 'catatan sprint 2 yang kedua bos', NULL, NULL, NULL, '2023-04-26 10:47:15', 43, '::1'),
(3, 11, 1006, 'PLANNING', NULL, 'Catatan sprint 3', NULL, NULL, NULL, '2023-04-11 07:21:25', 44, '::1'),
(4, 11, 1005, 'REVIEW', NULL, 'Ini sudah ok sekali ya', NULL, NULL, NULL, '2023-04-26 10:37:25', 43, '::1'),
(7, 11, 1005, '', NULL, 'cata retro simpanan ya', 'Link ok', NULL, NULL, '2023-04-21 08:20:08', 43, '::1'),
(8, 11, 1004, 'REVIEW', NULL, 'sdfghj', NULL, NULL, NULL, '2023-04-22 13:30:22', 43, '::1'),
(9, 11, 1004, '', NULL, 'Halo retro', 'Sudah bagus', NULL, NULL, '2023-04-22 13:30:37', 43, '::1'),
(10, 12, 1001, 'PLANNING', NULL, '', NULL, NULL, NULL, '2023-04-26 14:55:14', 43, '::1'),
(11, 12, 1001, '', NULL, 'test', 'sad', NULL, NULL, '2023-04-26 12:20:02', 43, '::1'),
(12, 12, 1002, 'PLANNING', NULL, 'Sprint 2 gaskeun', NULL, NULL, NULL, '2023-04-26 14:55:31', 43, '::1');
...
--
-- Table structure for table `support_error`
--

CREATE TABLE `support_error` (
  `id_support_error` bigint(20) NOT NULL,
  `judul` varchar(250) NOT NULL,
  `deskripsi` text DEFAULT NULL,
  `file_pendukung` varchar(250) DEFAULT NULL,
...
--
-- Dumping data for table `support_error`
--

INSERT INTO `support_error` (`id_support_error`, `judul`, `deskripsi`, `file_pendukung`, `is_solved`, `solved_date`, `created_date`, `created_id_user`, `created_ip_address`) VALUES
(1, 'Waw', 'Mantap', 'Ini file', 0, NULL, NULL, NULL, NULL),
(2, 'Waw', 'sss', 'logo - simdek.png', 0, NULL, NULL, NULL, NULL),
(3, 'Waw', 'sss', 'file-N2ZRUVc4ZlZySmoyRlV5aStFSGM2dz09.png', 0, NULL, NULL, NULL, NULL),
(4, 'Aplikasi ini masih sangat jauh dari sempurna', 'Silakan dibuat palikasi ', 'file-MytyZ2tHNWRNNUZ5ZWFkc0kxQ1A2UT09.jpeg', 0, NULL, NULL, NULL, NULL),
(5, 'sa', 'asdas', NULL, 0, NULL, NULL, NULL, NULL),
(6, 'asd', 'asdasda', NULL, 0, NULL, NULL, NULL, NULL),
(7, 's', 'sasdas', NULL, 0, NULL, NULL, NULL, NULL);
...
(37, 'ananda', 'tester@mail.com', 'tester@mail.com', '$2y$13$zumbMGxSBOSzQMCalyB3cuj44.NiiZZCXnYESJR3xmzPrjDqG9u56', 'F19G4ArL0mrwagKJDSyyDZbyPwbJoqvA', 10, 'Pp4_8knHybZcVsAhp5FYkk2aUbOsD0WI_1679040642', 'member', 0, 1679040642, 1679040642, ''),
(38, 'ananda', 'testerdudu@mail.com', 'testerdudu@mail.com', '$2y$13$3Rm1LiHXfprXfpaKCI/ov.uZjAXNPhKdjKQrHeRWGEMC26UQLTNoW', 'H9md3ZW3MN0PlqbEmCBW71HsoBSqO24S', 10, '9B_dMd-E_rZ119zVqQxZbxSnZugWsSFQ_1679707567', 'member', 0, 1679707567, 1679707567, ''),
(39, 'ananda', 'ananda@mail.com', 'ananda@mail.com', '$2y$13$04nND4NyPJtVFMlkODCWLOUB7e76gH6P1Jmhy05NDhU1MLo6d9eU6', 'ynumPYdoFfRSrEJqC3LB5iKXjy5j1V67', 10, '75FlDSDvVMoNMixWH35sJunxrGoU8XFl_1679790029', 'member', 0, 1679790029, 1679790029, ''),
(40, 'Budi Krisnawan', 'budi@telkom.id', 'budi@telkom.id', '$2y$13$L4d5xb9A5ieT9mxHJp7xLuNsQTmE9TGRaiwBtqVXNZdURZ7HW8ThO', '3jlskP7pgzjUVhIeP3_Eh1n6D04Mh2V9', 10, '8f5nb5FwRdF09nhqymWfLBg84-Lei_2q_1679791379', 'member', 0, 1679791379, 1679791379, ''),
(41, 'Budi Krisnawan', 'budikrisnawan@telkom.id', 'budikrisnawan@telkom.id', '$2y$13$BWmcFJ0Z//o5zRvjny9vBOocskVxz9ZKhTSfD9NVhj3IyQVCbUpy.', 'pL_B3RLiweMPtN3Ac4pZiRKisy4BZc05', 10, 'lODqPg9FGqJfN32bNzrRgDu6BROTTUEp_1679791430', 'member', 0, 1679791430, 1679791430, ''),
(42, 'Nanda Prasetyo', 'nandaprasetyo@mail.com', 'nandaprasetyo@mail.com', '$2y$13$NlBb8nW8W00EkXMraoi3d.nh1Ate3aN48SMXsLNjWVK6ADE.ppIlS', 'l9HgBTp8NZqqAsGiWqlatlVSPsuI8SLU', 10, 'FPmfmNgnJ9Ac_aZ9bmZ6ZIzUpksssXZf_1679791892', 'member', 0, 1679791892, 1679791892, ''),
(43, 'tester rpl', 'rpl1@mail.com', 'rpl1@mail.com', '$2y$13$wB.bM9qEkUovMi.Tu1jTt.Z/nWa3F0SIQM4kOtd0kfD5y7qyuLyDi', 'xSAdZaiUMMvqQ7y9dQ_gk8bz0O3euV0y', 10, 'hgPbDrfXh8Fz-6PIUFxRZncYJ9prjE0o_1679875427', 'member', 0, 1679875427, 1679875427, ''),
(44, 'rpl 2 bos', 'rpl2@mail.com', 'rpl2@mail.com', '$2y$13$03rGRLIpVt/CreYmR1BG3uMTGH84SEphjS7UFezw/fzR18UWpfMqm', 'GkYmikvO0r0d8hIO4GiCjoj3Smkzb0Ll', 10, '1HTtV9PMS5Jb--s0WaM64trrYUiolmj-_1680393970', 'member', 0, 1680393970, 1680393970, ''),
(45, 'rpl 3 sih bos', 'rpl3@mail.com', 'rpl3@mail.com', '$2y$13$qx2wvuRmqTBEK.VeFSl.bueawCOuxsex5505P2F9XCnglUy6GRLu.', 'NxvdLbMZOhgYB5n4ArjYubEZjqBt0Jbc', 10, 'VwVex0nPnUAK9FPkgEZ9u5Rh_L8gM1-S_1680395368', 'member', 0, 1680395368, 1680395368, ''),
(46, 'Rpl EMpat', 'rpl4@mail.com', 'rpl4@mail.com', '$2y$13$3ICBUVGIpebz2Q/SAQRBre.Hk..rJI4jIlr6IqkAXQGAQdirnG6ki', 'R-DEJ8QTs9LOdfHM3XJTtdthX-L6onaj', 10, 'QyNnO6i-caLQdxz_cGt-hOje2X2TkS5F_1680790825', 'member', 0, 1680790825, 1680790825, ''),
(47, 'bandit', 'bandit@mail.com', 'bandit@mail.com', '$2y$13$fI7MS8YQJFjcfkD0y1RpmO8MRsAacL7kkDw0pO9/Aj4SX8FPQ3kE6', 'P1WSa8F_POLBFn0SSe_hh29ZnDX15BT0', 10, '6h01owAcVbvp4J0pqOdu3CalFulypTfF_1680949140', 'member', 0, 1680949140, 1680949140, ''),
(48, 'susan', 'susan@mail.com', 'susan@mail.com', '$2y$13$URmthO6PnPfnSdHLmBrKseVemL4jFlLBUc6jz4MyKXZKB7GdJAzJO', 'aGHgKGKwrDqDXqsklyCwMwXAnNtyFBGG', 10, 'uzsZmj-OVkUo8Zz7RUlKLQtxhILGHyuz_1680950298', 'member', 0, 1680950298, 1680950298, ''),
(49, 'susan', 'susan2@mail.com', 'susan2@mail.com', '$2y$13$tiaaaHyEyeltdvz81/pjveHFzB7DF0YMKtxUAoNhJKXiHIVVsbbrK', 'k3v0IRhF1ZTdILd9fb2pnWA0Pvm8PyWS', 10, 'TKREf5S1fpRSk65ShccHnFW0fj0nv7oI_1680950333', 'member', 0, 1680950333, 1680950333, ''),
(50, 'susan', 'susan3@mail.com', 'susan3@mail.com', '$2y$13$T.e2aVfP/wBZgUxNnS26Cuk5/XEhoQxB/2Z10OHYPQqWERHg82MT6', 'WxXjWr7U0-9t3bESJMXGvI_XofwSXp6Q', 10, 'eiJWKyHjyv7O_uPfs_aR3bElZjhS_tnz_1680950389', 'member', 0, 1680950389, 1680950389, ''),
(51, 'susan', 'susan4@mail.com', 'susan4@mail.com', '$2y$13$JAXCwbMrUJHyWFhJYwqNw.GAci88t6BYQV5fbQL9RWHsQ0xHS.0lS', '3Q6sYzHDnyV1rAH6Vts7FvYkaAP2Pf7k', 10, 'fme32EXHHZ-Uc3WOwb3hS6oaBio8G6Jv_1680950465', 'member', 0, 1680950465, 1680950465, ''),
(52, 'susan', 'susan5@mail.com', 'susan5@mail.com', '$2y$13$Ry88BhE98qRvNX/Kw0RF0.M9.90yr/qP2WU8cR7sXBhFQWh8.v/Wq', 'uBKU9lawE_dZcPDFPiwhM0E0JPbVEqGW', 10, 'A5M4092cle1FasvGbWPX7j0hSY9vHgQX_1680950510', 'member', 0, 1680950510, 1680950510, '');
...
--
-- Indexes for table `el_course`
--
ALTER TABLE `el_course`
  ADD PRIMARY KEY (`id_course`);

--
-- Indexes for table `el_topic`
--
ALTER TABLE `el_topic`
...
--
-- Indexes for table `hrm_cv_asuransi`
--
...
--
-- Indexes for table `hrm_cv_keluarga`
--
...
--
-- Indexes for table `hrm_cv_kesehatan`
--
...
--
-- Indexes for table `hrm_cv_language_skill`
--
...
--
-- Indexes for table `hrm_cv_riwayat_pekerjaan`
--
...
--
-- Indexes for table `hrm_cv_riwayat_pendidikan`
--
...
--
-- Indexes for table `hrm_mst_bahasa`
--
...
--
-- Indexes for table `hrm_mst_jenis_asuransi`
--
ALTER TABLE `hrm_mst_jenis_asuransi`
  ADD PRIMARY KEY (`id_hrm_mst_jenis_asuransi`);

--
-- Indexes for table `hrm_mst_jenis_tunjangan_kesehatan`
--
...
--
-- Indexes for table `hrm_perusahaan_asuransi`
--
...
--
-- Indexes for table `mst_environment_attribute`
--
ALTER TABLE `mst_environment_attribute`
  ADD PRIMARY KEY (`id_mst_environment_attribute`);

--
-- Indexes for table `mst_environment_attribute_grade`
--
ALTER TABLE `mst_environment_attribute_grade`
  ADD PRIMARY KEY (`id_mst_environment_attribute_grade`),
  ADD KEY `id_mst_environment_attribute` (`id_mst_environment_attribute`);

--
-- Indexes for table `mst_jabatan_attribute`
--
ALTER TABLE `mst_jabatan_attribute`
  ADD PRIMARY KEY (`id_mst_jabatan_attribute`);

--
-- Indexes for table `mst_jabatan_attribute_grade`
--
ALTER TABLE `mst_jabatan_attribute_grade`
  ADD PRIMARY KEY (`id_mst_jabatan_attribute_grade`),
  ADD KEY `id_mst_jabatan_attribute` (`id_mst_jabatan_attribute`);

--
-- Indexes for table `mst_jenis_penyakit`
--
...
--
-- Indexes for table `mst_time_metric`
--
ALTER TABLE `mst_time_metric`
  ADD PRIMARY KEY (`id_time_metric`);
...
ALTER TABLE `product_backlog`
  ADD PRIMARY KEY (`id_product_backlog`),
  ADD KEY `id_project_mst_type` (`id_project_mst_type`),
  ADD KEY `id_wiki_page` (`id_wiki_page`),
  ADD KEY `id_time_metric` (`id_time_metric`),
...
ALTER TABLE `project`
  ...
  ADD KEY `id_perusahaan` (`id_perusahaan`,`kode_proyek`,`is_active`);
...
--
-- Indexes for table `project_mst_role`
--
ALTER TABLE `project_mst_role`
  ADD PRIMARY KEY (`id_project_mst_role`),
  ADD KEY `id_project_mst_type` (`id_project_mst_type`),
  ADD KEY `is_active` (`is_active`);

--
-- Indexes for table `project_mst_type`
--
ALTER TABLE `project_mst_type`
  ADD PRIMARY KEY (`id_project_mst_type`);
...
--
-- Indexes for table `pro_environment_attribute`
--
...
--
-- Indexes for table `pro_jabatan_attribute`
--
...
--
-- Indexes for table `pro_organization_attribute`
--
...
--
-- Indexes for table `pro_personal_attribute`
--
...
--
-- Indexes for table `publik_user`
--
ALTER TABLE `publik_user`
  ADD PRIMARY KEY (`id_publik_user`);
...
--
-- Indexes for table `scrum_daily`
--
ALTER TABLE `scrum_daily`
  ADD PRIMARY KEY (`id_scrum_daily`),
  ADD KEY `id_project` (`id_project`),
  ADD KEY `id_sprint` (`id_sprint`),
  ADD KEY `id_pegawai` (`id_pegawai`);

--
-- Indexes for table `scrum_daily_for_now`
--
ALTER TABLE `scrum_daily_for_now`
  ADD PRIMARY KEY (`id_scrum_daily_for_now`),
  ADD KEY `id_scrum_daily` (`id_scrum_daily`),
  ADD KEY `id_sprint_backlog` (`id_product_backlog`),
  ADD KEY `id_sprint` (`id_sprint`),
  ADD KEY `id_pegawai` (`id_pegawai`),
  ADD KEY `id_project` (`id_project`);

--
-- Indexes for table `scrum_daily_for_yesterday`
--
ALTER TABLE `scrum_daily_for_yesterday`
  ADD PRIMARY KEY (`id_scrum_daily_for_yesterday`),
  ADD KEY `id_scrum_daily` (`id_scrum_daily`),
  ADD KEY `id_sprint_backlog` (`id_product_backlog`),
  ADD KEY `id_sprint` (`id_sprint`),
  ADD KEY `id_project` (`id_project`),
...
ALTER TABLE `sprint`
  ...
  ADD KEY `id_project` (`id_project`),
  ADD KEY `sprint_number` (`sprint_number`),
  ADD KEY `is_active` (`is_active`),
...
ALTER TABLE `sprint_backlog`
  ADD PRIMARY KEY (`id_sprint_backlog`),
  ADD KEY `id_project` (`id_project`),
  ADD KEY `id_sprint` (`id_sprint`),
  ADD KEY `id_product_backlog` (`id_product_backlog`),
  ADD KEY `id_time_metric` (`id_time_metric`);

--
-- Indexes for table `sprint_ceremony`
--
ALTER TABLE `sprint_ceremony`
  ADD PRIMARY KEY (`id_sprint_ceremony`),
  ADD KEY `ceremony` (`ceremony`),
  ADD KEY `id_project` (`id_project`),
  ADD KEY `id_sprint` (`id_sprint`);
...
--
-- Indexes for table `support_error`
--
ALTER TABLE `support_error`
  ADD PRIMARY KEY (`id_support_error`);
...
--
ALTER TABLE `app_setting`
  MODIFY `id_app_setting` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=212;
...
--
ALTER TABLE `data_sekolah`
  MODIFY `id_sekolah` bigint(21) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `el_course`
--
ALTER TABLE `el_course`
  MODIFY `id_course` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `el_topic`
--
ALTER TABLE `el_topic`
...
--
-- AUTO_INCREMENT for table `hrm_cv_asuransi`
--
ALTER TABLE `hrm_cv_asuransi`
  MODIFY `id_cv_asuransi` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `hrm_cv_keluarga`
--
ALTER TABLE `hrm_cv_keluarga`
  MODIFY `id_keluarga` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `hrm_cv_kesehatan`
--
ALTER TABLE `hrm_cv_kesehatan`
  MODIFY `id_cv_kesehatan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `hrm_cv_language_skill`
--
ALTER TABLE `hrm_cv_language_skill`
  MODIFY `id_language_skill` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `hrm_cv_riwayat_pekerjaan`
--
ALTER TABLE `hrm_cv_riwayat_pekerjaan`
  MODIFY `id_riwayat_pekerjaan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `hrm_cv_riwayat_pendidikan`
--
ALTER TABLE `hrm_cv_riwayat_pendidikan`
  MODIFY `id_riwayat_pendidikan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `hrm_mst_bahasa`
--
ALTER TABLE `hrm_mst_bahasa`
  MODIFY `id_mst_bahasa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT for table `hrm_mst_jenis_asuransi`
--
ALTER TABLE `hrm_mst_jenis_asuransi`
  MODIFY `id_hrm_mst_jenis_asuransi` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `hrm_mst_jenis_tunjangan_kesehatan`
--
ALTER TABLE `hrm_mst_jenis_tunjangan_kesehatan`
  MODIFY `id_mst_jenis_tunjangan_kesehatan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `hrm_pegawai`
--
ALTER TABLE `hrm_pegawai`
  MODIFY `id_pegawai` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT for table `hrm_perusahaan_asuransi`
--
ALTER TABLE `hrm_perusahaan_asuransi`
...
--
ALTER TABLE `landing_home`
  MODIFY `id_landing_home` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
...
--
-- AUTO_INCREMENT for table `mst_environment_attribute`
--
ALTER TABLE `mst_environment_attribute`
  MODIFY `id_mst_environment_attribute` bigint(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mst_environment_attribute_grade`
--
ALTER TABLE `mst_environment_attribute_grade`
  MODIFY `id_mst_environment_attribute_grade` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mst_jabatan_attribute`
--
ALTER TABLE `mst_jabatan_attribute`
  MODIFY `id_mst_jabatan_attribute` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `mst_jabatan_attribute_grade`
--
ALTER TABLE `mst_jabatan_attribute_grade`
  MODIFY `id_mst_jabatan_attribute_grade` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mst_jenis_penyakit`
--
ALTER TABLE `mst_jenis_penyakit`
...
--
-- AUTO_INCREMENT for table `mst_organization_attribute`
--
ALTER TABLE `mst_organization_attribute`
  MODIFY `id_mst_organization_attribute` bigint(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mst_organization_attribute_grade`
--
ALTER TABLE `mst_organization_attribute_grade`
  MODIFY `id_mst_organization_attribute_grade` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mst_personal_attribute`
--
ALTER TABLE `mst_personal_attribute`
  MODIFY `id_mst_personal_attribute` bigint(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `mst_personal_attribute_grade`
--
ALTER TABLE `mst_personal_attribute_grade`
  MODIFY `id_mst_personal_attribute_grade` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `mst_time_metric`
--
ALTER TABLE `mst_time_metric`
  MODIFY `id_time_metric` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `mst_tingkat_pendidikan`
--
ALTER TABLE `mst_tingkat_pendidikan`
  MODIFY `id_mst_tingkat_pendidikan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `product_backlog`
  MODIFY `id_product_backlog` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=35;

--
-- AUTO_INCREMENT for table `project`
--
ALTER TABLE `project`
  MODIFY `id_project` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;

--
-- AUTO_INCREMENT for table `project_member`
--
ALTER TABLE `project_member`
  MODIFY `id_project_member` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `project_mst_role`
--
ALTER TABLE `project_mst_role`
  MODIFY `id_project_mst_role` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=104;

--
-- AUTO_INCREMENT for table `project_mst_type`
--
ALTER TABLE `project_mst_type`
  MODIFY `id_project_mst_type` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `pro_environment_attribute`
--
ALTER TABLE `pro_environment_attribute`
  MODIFY `id_pro_environment_attribute` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pro_jabatan_attribute`
--
ALTER TABLE `pro_jabatan_attribute`
  MODIFY `id_pro_jabatan_attribute` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pro_organization_attribute`
--
ALTER TABLE `pro_organization_attribute`
  MODIFY `id_pro_organization_attribute` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `pro_personal_attribute`
--
ALTER TABLE `pro_personal_attribute`
  MODIFY `id_pro_personal_attribute` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `publik_user`
--
ALTER TABLE `publik_user`
  MODIFY `id_publik_user` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=149;
...
--
-- AUTO_INCREMENT for table `scrum_daily`
--
ALTER TABLE `scrum_daily`
  MODIFY `id_scrum_daily` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `scrum_daily_for_now`
--
ALTER TABLE `scrum_daily_for_now`
  MODIFY `id_scrum_daily_for_now` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `scrum_daily_for_yesterday`
--
ALTER TABLE `scrum_daily_for_yesterday`
  MODIFY `id_scrum_daily_for_yesterday` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `sprint`
  MODIFY `id_sprint` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1009;

--
-- AUTO_INCREMENT for table `sprint_backlog`
--
ALTER TABLE `sprint_backlog`
  MODIFY `id_sprint_backlog` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- AUTO_INCREMENT for table `sprint_ceremony`
--
ALTER TABLE `sprint_ceremony`
  MODIFY `id_sprint_ceremony` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
-- AUTO_INCREMENT for table `support_error`
--
ALTER TABLE `support_error`
  MODIFY `id_support_error` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
