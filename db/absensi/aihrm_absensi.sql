...
CREATE TABLE `absensi_log` (
  `id_absensi_log` bigint(20) NOT NULL,
...
CREATE TABLE `absensi_type` (
  `id_absensi_type` int(11) NOT NULL,
  `absensi_type` varchar(250) NOT NULL,
...
INSERT INTO `absensi_type` (`id_absensi_type`, `absensi_type`, `keterangan`) VALUES
(1, 'CHECK-IN', 'Masuk'),
(2, 'CHECK-OUT', 'Keluar / Pulang'),
(3, 'LEFT-OUT', 'Ijin sebentar untuk keperluan di luar kantor'),
(4, 'LEFT-IN', 'Kembali dari ijin sebentar');
...
(2, 'APP-NAME-SINGKAT', 0, 'ABSENSI'),
(3, 'APP-NAME-SINGKATAN', 0, 'ABENSI'),
(4, 'Logo', 1, 'Logo.jpg'),
(5, 'Icon', 1, 'Icon.jpg'),
...
('/absensi-type/*', 2, NULL, NULL, NULL, 1678700748, 1678700748),
...
(13000, 0, 1, 'Absensi', 'sliders', 'Absensi', 'Absensi', '#', 0, 'admin', '', 1),
(13001, 13000, 0, 'Riwayat Absensi', 'file-o', 'Riwayat Absensi', 'Riwayat Absensi', 'personal-attribute/index', 0, 'admin', 'MOBILE_TOP', 1),
(13002, 13000, 0, 'Yang lain', 'database', 'Yang lain', 'Yang lain', 'mst-personal-attribute/index', 0, 'admin', 'MOBILE_TOP', 1),
(13003, 13000, 0, 'Test', 'database', 'Test', 'Test', 'mst-personal-attribute-grade/index', 0, 'admin', 'MOBILE_TOP', 1),
...
ALTER TABLE `absensi_type`
  ADD PRIMARY KEY (`id_absensi_type`);
...
--
ALTER TABLE `absensi_log`
  MODIFY `id_absensi_log` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `absensi_type`
--
ALTER TABLE `absensi_type`
  MODIFY `id_absensi_type` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
