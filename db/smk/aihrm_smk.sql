...
--
-- Host: localhost
-- Generation Time: Jun 15, 2023 at 03:44 PM
...
('/approval-penilaian/*', 2, NULL, NULL, NULL, 1682883378, 1682883378),
...
('/hrm-kantor-new/*', 2, NULL, NULL, NULL, 1685344531, 1685344531),
('/hrm-kantor/*', 2, NULL, NULL, NULL, 1680771638, 1680771638),
...
('/pegawai/*', 2, NULL, NULL, NULL, 1685347450, 1685347450),
...
('/penilaian/*', 2, NULL, NULL, NULL, 1686558747, 1686558747),
('/perencanaan-penilaian/*', 2, NULL, NULL, NULL, 1685517764, 1685517764),
('/perencanan-penilaian/*', 2, NULL, NULL, NULL, 1685517730, 1685517730),
...
('/rekap-penilaian-bawahan/*', 2, NULL, NULL, NULL, 1686038853, 1686038853),
('/rekap-penilaian-individu/*', 2, NULL, NULL, NULL, 1686038403, 1686038403),
('/rekap-penilaian/*', 2, NULL, NULL, NULL, 1682958897, 1682958897),
('/rencana-penilaian/*', 2, NULL, NULL, NULL, 1680772119, 1680772119),
...
('/smk-aspek-penilaian/*', 2, NULL, NULL, NULL, 1680769900, 1680769900),
('/smk-aspek-rencana/*', 2, NULL, NULL, NULL, 1685514312, 1685514312),
('/smk-aspek-rentang-nilai/*', 2, NULL, NULL, NULL, 1686834952, 1686834952),
('/smk-index-nilai/*', 2, NULL, NULL, NULL, 1685764853, 1685764853),
('/smk-jenis-penilaian/*', 2, NULL, NULL, NULL, 1686834985, 1686834985),
('/smk-mst-jenis-periode/*', 2, NULL, NULL, NULL, 1680769695, 1680769695),
('/smk-pegawai-tahunan/*', 2, NULL, NULL, NULL, 1686246154, 1686246154),
('/smk-pegawai/*', 2, NULL, NULL, NULL, 1685511467, 1685511467),
('/smk-periode/*', 2, NULL, NULL, NULL, 1680770060, 1680770060),
...
('admin', '/pendapatan/*'),
('admin', '/perencanaan-penilaian/*'),
('admin', '/perencanan-penilaian/*'),
...
('admin', '/purchase-raw/*'),
('admin', '/rekap-penilaian/*'),
('admin', '/rencana-penilaian/*'),
...
('admin', '/site/login'),
('admin', '/site/logout'),
('admin', '/smk-aspek-penilaian/*'),
('admin', '/smk-aspek-rencana/*'),
('admin', '/smk-aspek-rentang-nilai/*'),
('admin', '/smk-index-nilai/*'),
('admin', '/smk-jenis-penilaian/*'),
('admin', '/smk-mst-jenis-periode/*'),
('admin', '/smk-pegawai-tahunan/*'),
('admin', '/smk-pegawai/*'),
('admin', '/smk-periode/*'),
...
('member', '/penilaian/*'),
('member', '/rekap-penilaian-bawahan/*'),
('member', '/rekap-penilaian-individu/*'),
('member', '/site/index'),
('member', '/smk-pegawai/*'),
...
(1300, 0, 1, 'Penilaian Kinerja', 'file-o', 'Penilaian Kinerja', 'Penilaian Kinerja', '#', 0, 'member', '', 1),
(1301, 1300, 0, 'Penilaian Kinerja', 'comments-o', 'Penilaian Kinerja', 'Penilaian Kinerja', 'penilaian/index', 0, 'member', 'MOBILE_TOP', 1),
(1302, 1300, 0, 'Approval Individu', 'comments-o', 'Approval Individu', 'Approval Individu', '/index', 0, 'member', 'MOBILE_TOP', 1),
(1303, 1300, 0, 'Approval Bawahan', 'comments-o', 'Approval Bawahan', 'Approval Bawahan', '/index', 0, 'member', 'MOBILE_TOP', 1),
(1304, 1300, 0, 'Rekap Individu', 'comments-o', 'Rekap Individu', 'Rekap Individu', '/rekap-penilaian-individu/index', 0, 'member', 'MOBILE_TOP', 1),
(1305, 1300, 0, 'Rekap Bawahan', 'comments-o', 'Rekap Bawahan', 'Rekap Bawahan', '/rekap-penilaian-bawahan/index', 0, 'member', 'MOBILE_TOP', 1),
(1306, 1300, 0, 'Keahlian Bahasa', 'comments-o', 'Keahlian Bahasa', 'Keahlian Bahasa', 'hrm-cv-language-skill/index', 0, 'member', 'MOBILE_TOP', 0),
(12000, 0, 1, 'Data Pegawai', 'users', 'Data Pegawai', 'Data Pegawai', '#', 0, 'admin', '', 0),
(12001, 12000, 0, 'Data Pegawai', 'user', 'Data Pegawai', 'Data Pegawai', 'hrm-pegawai/index', 0, 'admin', 'MOBILE_TOP', 1),
(13000, 0, 1, 'Master Data', 'database', 'Master Data', 'Master Data', '#', 0, 'admin', '', 1),
(13001, 13000, 0, 'Data Pegawai', 'user', 'Data Pegawai', 'Data Pegawai', 'hrm-pegawai/index', 0, 'admin', 'MOBILE_TOP', 1),
(13002, 13000, 0, 'Kantor', 'building', 'Kantor', 'Kantor', 'hrm-kantor-new/index', 0, 'admin', 'MOBILE_TOP', 1),
(13003, 13000, 0, 'Mapping Pegawai', 'list-alt', 'Mapping Pegawai', 'Mapping Pegawai', 'hrm-kantor/index', 0, 'admin', 'MOBILE_TOP', 1),
(14000, 0, 1, 'Konfigurasi Atribut Jabatan', 'sliders', 'Konfigurasi Atribut Jabatan', 'Konfigurasi Atribut Jabatan', '#', 0, 'admin', '', 0),
...
(15000, 0, 1, 'Konfigurasi Atribut Environment', 'sliders', 'Konfigurasi Atribut Environment', 'Konfigurasi Atribut Environment', '#', 0, 'admin', '', 0),
...
(16000, 0, 1, 'Konfigurasi Atribut Organization', 'sliders', 'Konfigurasi Atribut Organization', 'Konfigurasi Atribut Organization', '#', 0, 'admin', '', 0),
...
(17000, 0, 1, 'Matching Atribut ', 'sliders', 'Matching Atribut ', 'Matching Atribut ', '#', 0, 'admin', '', 0),
...
(34000, 0, 1, 'Penilaian Kinerja', 'file-o', 'Penilaian Kinerja', 'Penilaian Kinerja', '#', 0, 'admin', '', 1),
(34001, 34000, 0, 'Jadwal Penilaian', 'graduation-cap', 'Jadwal Penilaian', 'Jadwal Penilaian', 'smk-periode/index', 0, 'admin', 'MOBILE_TOP', 1),
(34002, 34000, 0, 'Rencana Aspek', 'building', 'Rencana Aspek', 'Rencana Aspek', 'smk-aspek-penilaian/index', 0, 'admin', 'MOBILE_TOP', 1),
(34003, 34000, 0, 'Rencana Penilaian', 'list-alt', 'Rencana Penilaian', 'Rencana Penilaian', 'perencanaan-penilaian/index', 0, 'admin', 'MOBILE_TOP', 1),
(34004, 34000, 0, 'Rekap Penilaian', 'language', 'Rekap Penilaian', 'Rekap Penilaian', 'smk-pegawai-tahunan/index', 0, 'admin', 'MOBILE_TOP', 1),
(34005, 34000, 0, 'Reset Penilaian', 'money', 'Reset Penilaian', 'Reset Penilaian', 'smk-pegawai-tahunan/index', 0, 'admin', 'MOBILE_TOP', 1),
(34006, 34000, 0, 'Jenis Periode ', 'heartbeat', 'Jenis Periode ', 'Jenis Periode ', 'smk-mst-jenis-periode/index', 0, 'admin', 'MOBILE_TOP', 1),
(34007, 34000, 0, 'Jenis Nilai', 'wheelchair', 'Jenis Nilai', 'Jenis Nilai', 'smk-jenis-penilaian/index', 0, 'admin', 'MOBILE_TOP', 1),
(34008, 34000, 0, 'Aspek Rentang Nilai', 'hospital-o', 'Aspek Rentang Nilai', 'Aspek Rentang Nilai', 'smk-aspek-rentang-nilai/index', 0, 'admin', 'MOBILE_TOP', 1),
...
(1, NULL, 16, 12, 3, 2010, 2012, 2, '3.14', 'test', 'test', '0000-00-00', '', '', '0000-00-00', '', ''),
(2, NULL, 16, 11, 1, 2010, 2016, 1, '43.11', '-', '-', '0000-00-00', '', '', '0000-00-00', '', ''),
(3, NULL, 16, 21, 2, 2018, 2021, 1, '3.92', '--', '--', '0000-00-00', '', '', '0000-00-00', '', ''),
(4, NULL, 16, 12, 2, 2018, 2021, 1, '3.92', '--', '--', '0000-00-00', '', '', '0000-00-00', '', '');

-- --------------------------------------------------------

--
-- Table structure for table `hrm_kantor`
--

CREATE TABLE `hrm_kantor` (
  `id_hrm_kantor` bigint(20) NOT NULL,
  `id_perusahaan` bigint(20) NOT NULL,
  `nama_kantor` varchar(250) NOT NULL,
  `id_hrm_kantor_parent` bigint(20) NOT NULL,
  `id_kantor_kategori` int(11) NOT NULL,
...
--
-- Dumping data for table `hrm_kantor`
--

INSERT INTO `hrm_kantor` (`id_hrm_kantor`, `id_perusahaan`, `nama_kantor`, `id_hrm_kantor_parent`, `id_kantor_kategori`, `alamat_kantor`, `id_kabupaten`, `id_propinsi`, `latitude`, `longitude`, `fax`, `telepon`, `email`) VALUES
(11575, 12123, 'Kantor Bogor', 12, 123, 'Kost Pondok Abad, Citeureup, Kec. Dayeuhkolot, Bandung, Jawa Barat 40257', 12312, 123, 'qweq', 'qweq', 'qweqw', '082138711691', 'shobrunjb@gmailc.om');
...
(1, 1, 201501, 'PENILAIAN PENDEKATAN SISTEM SIKLUS', 'PENILAIAN PENDEKATAN SISTEM SIKLUS', 'UTAMA', 1, 1),
(2, 1, 201501, 'PENILAIAN PENDEKATAN PROGRESS CABANG', 'PENILAIAN PENDEKATAN PROGRESS CABANG', 'UTAMA', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `smk_aspek_rencana`
--

CREATE TABLE `smk_aspek_rencana` (
  `id_smk_aspek_rencana` bigint(20) NOT NULL,
  `type` set('TAHUNAN','PERIODE','UNKNOWN') DEFAULT NULL COMMENT 'Menyatakan type dari SMK. Tahunan atau Per Periode/ Triwulan',
  `tahun` int(4) DEFAULT NULL,
  `id_smk_periode` int(11) DEFAULT NULL COMMENT 'Informasi tentang periode. Misal TRIWULAN I, II, III, IV, dst. Jika typenya TAHUNAN maka boleh dikosongkan',
  `sasaran` varchar(1000) DEFAULT NULL,
  `plan_sasaran` varchar(1200) DEFAULT NULL,
  `id_smk_sasaran_position` bigint(20) DEFAULT NULL,
  `no` int(11) DEFAULT NULL,
  `rev` int(11) DEFAULT 1,
  `rev_pre_sasaran` varchar(100) DEFAULT NULL,
  `id_smk_mst_jenis_penilaian` int(11) DEFAULT NULL,
  `id_aspek_penilaian` int(11) DEFAULT NULL,
  `target` varchar(150) NOT NULL,
  `ukuran_pencapaian` varchar(150) DEFAULT NULL,
  `sub_bobot` double(5,3) NOT NULL,
  `id_smk_jenis_penilaian` int(11) NOT NULL,
  `id_smk_aspek_rentang_nilai` int(11) NOT NULL,
  `plan_id_smk_mst_jenis_penilaian` int(11) DEFAULT NULL,
  `plan_id_aspek_penilaian` int(11) DEFAULT NULL,
  `plan_target` varchar(150) DEFAULT NULL,
  `plan_ukuran_pencapaian` varchar(150) DEFAULT NULL,
  `plan_sub_bobot` double(5,3) DEFAULT NULL,
  `plan_a_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_ii` varchar(150) DEFAULT NULL,
  `plan_b_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_b_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_b_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_b_rentang_2_ii` varchar(150) DEFAULT NULL,
  `plan_c_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_c_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_c_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_c_rentang_2_ii` varchar(150) DEFAULT NULL,
  `plan_d_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_d_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_d_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_d_rentang_2_ii` varchar(150) DEFAULT NULL,
  `plan_e_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_e_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_e_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_e_rentang_2_ii` varchar(150) DEFAULT NULL,
  `plan_f_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_f_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_f_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_f_rentang_2_ii` varchar(150) DEFAULT NULL,
  `bc_sub_bobot` double(5,3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `smk_aspek_rencana`
--

INSERT INTO `smk_aspek_rencana` (`id_smk_aspek_rencana`, `type`, `tahun`, `id_smk_periode`, `sasaran`, `plan_sasaran`, `id_smk_sasaran_position`, `no`, `rev`, `rev_pre_sasaran`, `id_smk_mst_jenis_penilaian`, `id_aspek_penilaian`, `target`, `ukuran_pencapaian`, `sub_bobot`, `id_smk_jenis_penilaian`, `id_smk_aspek_rentang_nilai`, `plan_id_smk_mst_jenis_penilaian`, `plan_id_aspek_penilaian`, `plan_target`, `plan_ukuran_pencapaian`, `plan_sub_bobot`, `plan_a_rentang_1_i`, `plan_a_rentang_1_ii`, `plan_a_rentang_2_i`, `plan_a_rentang_2_ii`, `plan_b_rentang_1_i`, `plan_b_rentang_1_ii`, `plan_b_rentang_2_i`, `plan_b_rentang_2_ii`, `plan_c_rentang_1_i`, `plan_c_rentang_1_ii`, `plan_c_rentang_2_i`, `plan_c_rentang_2_ii`, `plan_d_rentang_1_i`, `plan_d_rentang_1_ii`, `plan_d_rentang_2_i`, `plan_d_rentang_2_ii`, `plan_e_rentang_1_i`, `plan_e_rentang_1_ii`, `plan_e_rentang_2_i`, `plan_e_rentang_2_ii`, `plan_f_rentang_1_i`, `plan_f_rentang_1_ii`, `plan_f_rentang_2_i`, `plan_f_rentang_2_ii`, `bc_sub_bobot`) VALUES
(10, NULL, 2023, 53, 'TOTAL PENYALURAN', NULL, NULL, NULL, 1, NULL, NULL, 1, '470.000.000', NULL, 20.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, NULL, 2023, 53, 'REPAYMENT', NULL, NULL, NULL, 1, NULL, NULL, 1, '400.000.000', NULL, 20.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, NULL, 2023, 53, 'PENDAPATAN MARGIN', NULL, NULL, NULL, 1, NULL, NULL, 1, '4.000.000', NULL, 30.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, NULL, 2023, 53, 'BINAAN', NULL, NULL, NULL, 1, NULL, NULL, 1, '12.000.000', NULL, 20.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, NULL, 2023, 53, 'PENAMPILAN KERJA', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, NULL, 2023, 53, 'KOMUNIKASI', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(17, NULL, 2023, 53, 'INISIATIF', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(18, NULL, 2023, 53, 'DISIPLIN', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 20.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, NULL, 2023, 53, 'TANGGUNG JAWAB', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 20.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, NULL, 2023, 53, 'MOTIVASI', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(21, NULL, 2023, 53, 'KERJASAMA', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, NULL, 2023, 53, 'PEMILIHAN LOKASI', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, NULL, 2023, 53, 'SURVEI', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, NULL, 2023, 53, 'PERTEMUAN UMUM', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(25, NULL, 2023, 53, 'UJI KELAYAKAN', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(26, NULL, 2023, 53, 'PRA LWK', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(27, NULL, 2023, 53, 'LWK', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(28, NULL, 2023, 53, 'MEMBUAT LAPORAN', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(29, NULL, 2023, 53, 'PENYESUAIIAN DIRI', NULL, NULL, NULL, 1, NULL, NULL, 2, 'A', NULL, 5.000, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `smk_aspek_rentang_nilai`
--

CREATE TABLE `smk_aspek_rentang_nilai` (
  `id_smk_aspek_rentang_nilai` bigint(20) NOT NULL,
  `nama_rentang_nilai` varchar(250) NOT NULL,
  `predikat` varchar(50) NOT NULL,
  `predikat_nilai` int(11) NOT NULL,
  `is_has_rentang` int(1) DEFAULT NULL,
  `batas_bawah` bigint(20) DEFAULT NULL,
  `batas_atas` bigint(20) DEFAULT NULL,
  `label` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `smk_aspek_rentang_nilai`
--

INSERT INTO `smk_aspek_rentang_nilai` (`id_smk_aspek_rentang_nilai`, `nama_rentang_nilai`, `predikat`, `predikat_nilai`, `is_has_rentang`, `batas_bawah`, `batas_atas`, `label`) VALUES
(1, 'NILAI PENDAPATAN MARGIN', 'A', 5, 1, 361600001, 452000000, NULL),
(2, 'NILAI PENDAPATAN MARGIN', 'B', 4, 1, 271200001, 361600000, NULL),
(3, 'NILAI PENDAPATAN MARGIN', 'C', 3, 1, 180800001, 271200000, NULL),
(4, 'NILAI PENDAPATAN MARGIN', 'D', 2, 1, 90400001, 180800000, NULL),
(5, 'NILAI PENDAPATAN MARGIN', 'E', 1, 1, 0, 90400000, NULL),
(6, 'TOTAL PENYALURAN ', 'A', 5, 1, 1136000001, 1420000000, NULL),
(7, 'TOTAL PENYALURAN', 'B', 4, 1, 852000001, 1136000000, NULL),
(8, 'TOTAL PENYALURAN', 'C', 3, 1, 568000001, 852000000, NULL),
(9, 'TOTAL PENYALURAN', 'D', 2, 1, 284000001, 568000000, NULL),
(10, 'TOTAL PENYALURAN', 'E', 1, 1, 0, 284000000, NULL),
(11, 'NILAI KELAKUAN', 'A', 5, 0, NULL, NULL, 'Sangat Baik'),
(12, 'NILAI KELAKUAN', 'B', 4, 0, NULL, NULL, 'Baik'),
(13, 'NILAI KELAKUAN', 'C', 3, 0, NULL, NULL, 'Cukup'),
(14, 'NILAI KELAKUAN', 'D', 2, 0, NULL, NULL, 'Kurang'),
(15, 'NILAI KELAKUAN', 'E', 1, 0, NULL, NULL, 'Sangat Kurang');

-- --------------------------------------------------------

--
-- Table structure for table `smk_jenis_penilaian`
--

CREATE TABLE `smk_jenis_penilaian` (
  `id_smk_jenis_penilaian` int(11) NOT NULL,
  `jenis_penilaian` varchar(250) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `smk_jenis_penilaian`
--

INSERT INTO `smk_jenis_penilaian` (`id_smk_jenis_penilaian`, `jenis_penilaian`) VALUES
(1, 'Dropdown dengan Rentang'),
(2, 'Dropdown only');

-- --------------------------------------------------------

--
-- Table structure for table `smk_mst_jenis_periode`
--

CREATE TABLE `smk_mst_jenis_periode` (
  `id_smk_mst_jenis_periode` int(11) NOT NULL,
  `id_perusahaan` bigint(20) NOT NULL,
  `jenis_periode` varchar(250) NOT NULL,
  `jumlah` int(11) NOT NULL,
  `deskripsi` varchar(250) DEFAULT NULL,
  `is_used` int(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Dumping data for table `smk_mst_jenis_periode`
--

INSERT INTO `smk_mst_jenis_periode` (`id_smk_mst_jenis_periode`, `id_perusahaan`, `jenis_periode`, `jumlah`, `deskripsi`, `is_used`) VALUES
(13, 201501, 'TAHUNAN', 1, '', 0),
(14, 201501, 'SEMESTER', 2, '', 0),
(15, 201501, 'TRIWULAN', 4, '', 1),
(16, 201501, 'BULANAN', 12, '', 0);

-- --------------------------------------------------------

--
-- Table structure for table `smk_pegawai`
--

CREATE TABLE `smk_pegawai` (
  `id_smk_pegawai` bigint(20) NOT NULL,
  `id_smk_pegawai_tahunan` bigint(20) NOT NULL COMMENT 'ID untuk mengetahui SMK ini menempel kepada pegawai yang mana',
  `id_smk_aspek_rencana` bigint(20) NOT NULL DEFAULT 0,
  `type` set('TAHUNAN','PERIODE','UNKNOWN') DEFAULT NULL COMMENT 'Menyatakan type dari SMK. Tahunan atau Per Periode/ Triwulan',
  `tahun` int(4) NOT NULL,
  `id_smk_periode` int(11) DEFAULT NULL COMMENT 'Informasi tentang periode. Misal TRIWULAN I, II, III, IV, dst. Jika typenya TAHUNAN maka boleh dikosongkan',
  `sasaran` varchar(1000) DEFAULT NULL,
  `plan_sasaran` varchar(1200) DEFAULT NULL,
  `real_sasaran` varchar(1200) DEFAULT NULL,
  `id_smk_sasaran_position` bigint(20) DEFAULT NULL,
  `no` int(11) DEFAULT NULL,
  `rev` int(11) DEFAULT 1,
  `rev_pre_sasaran` varchar(100) DEFAULT NULL,
  ...
  `target` varchar(150) NOT NULL,
  `ukuran_pencapaian` varchar(150) DEFAULT NULL,
  `sub_bobot` double(5,3) DEFAULT NULL,
  `plan_id_smk_mst_jenis_penilaian` int(11) DEFAULT NULL,
  `plan_id_aspek_penilaian` int(11) DEFAULT NULL,
  `plan_target` varchar(150) DEFAULT NULL,
  `plan_ukuran_pencapaian` varchar(150) DEFAULT NULL,
  `plan_sub_bobot` double(5,3) DEFAULT NULL,
  `real_id_smk_mst_jenis_penilaian` int(11) DEFAULT NULL,
  `real_id_aspek_penilaian` int(11) DEFAULT NULL,
  `real_target` varchar(150) DEFAULT NULL,
  `real_ukuran_pencapaian` varchar(150) DEFAULT NULL,
  `real_sub_bobot` double(5,3) DEFAULT NULL,
  `plan_a_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_ii` varchar(150) DEFAULT NULL,
  ...
  `plan_f_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_f_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_a_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_a_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_a_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_a_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_b_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_b_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_b_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_b_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_c_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_c_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_c_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_c_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_d_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_d_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_d_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_d_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_e_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_e_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_e_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_e_rentang_2_ii` varchar(150) DEFAULT NULL,
  `real_f_rentang_1_i` varchar(150) DEFAULT NULL,
  `real_f_rentang_1_ii` varchar(150) DEFAULT NULL,
  `real_f_rentang_2_i` varchar(150) DEFAULT NULL,
  `real_f_rentang_2_ii` varchar(150) DEFAULT NULL,
  `bc_sub_bobot` double(5,3) DEFAULT NULL,
  `bmb_capaian` varchar(150) DEFAULT NULL,
  `bmb_nilai_sementara` varchar(100) DEFAULT NULL,
  `bmb_total_poin_sementara` double(6,2) DEFAULT NULL,
  `bmb_catatan` varchar(250) DEFAULT NULL,
  `final_capaian` varchar(150) DEFAULT NULL,
  `final_nilai_sementara` varchar(100) DEFAULT NULL,
  `final_total_poin_sementara` double(6,2) DEFAULT NULL,
  `final_catatan` varchar(250) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `smk_pegawai`
--

INSERT INTO `smk_pegawai` (`id_smk_pegawai`, `id_smk_pegawai_tahunan`, `id_smk_aspek_rencana`, `type`, `tahun`, `id_smk_periode`, `sasaran`, `plan_sasaran`, `real_sasaran`, `id_smk_sasaran_position`, `no`, `rev`, `rev_pre_sasaran`, `id_smk_mst_jenis_penilaian`, `id_aspek_penilaian`, `target`, `ukuran_pencapaian`, `sub_bobot`, `plan_id_smk_mst_jenis_penilaian`, `plan_id_aspek_penilaian`, `plan_target`, `plan_ukuran_pencapaian`, `plan_sub_bobot`, `real_id_smk_mst_jenis_penilaian`, `real_id_aspek_penilaian`, `real_target`, `real_ukuran_pencapaian`, `real_sub_bobot`, `plan_a_rentang_1_i`, `plan_a_rentang_1_ii`, `plan_a_rentang_2_i`, `plan_a_rentang_2_ii`, `plan_b_rentang_1_i`, `plan_b_rentang_1_ii`, `plan_b_rentang_2_i`, `plan_b_rentang_2_ii`, `plan_c_rentang_1_i`, `plan_c_rentang_1_ii`, `plan_c_rentang_2_i`, `plan_c_rentang_2_ii`, `plan_d_rentang_1_i`, `plan_d_rentang_1_ii`, `plan_d_rentang_2_i`, `plan_d_rentang_2_ii`, `plan_e_rentang_1_i`, `plan_e_rentang_1_ii`, `plan_e_rentang_2_i`, `plan_e_rentang_2_ii`, `plan_f_rentang_1_i`, `plan_f_rentang_1_ii`, `plan_f_rentang_2_i`, `plan_f_rentang_2_ii`, `real_a_rentang_1_i`, `real_a_rentang_1_ii`, `real_a_rentang_2_i`, `real_a_rentang_2_ii`, `real_b_rentang_1_i`, `real_b_rentang_1_ii`, `real_b_rentang_2_i`, `real_b_rentang_2_ii`, `real_c_rentang_1_i`, `real_c_rentang_1_ii`, `real_c_rentang_2_i`, `real_c_rentang_2_ii`, `real_d_rentang_1_i`, `real_d_rentang_1_ii`, `real_d_rentang_2_i`, `real_d_rentang_2_ii`, `real_e_rentang_1_i`, `real_e_rentang_1_ii`, `real_e_rentang_2_i`, `real_e_rentang_2_ii`, `real_f_rentang_1_i`, `real_f_rentang_1_ii`, `real_f_rentang_2_i`, `real_f_rentang_2_ii`, `bc_sub_bobot`, `bmb_capaian`, `bmb_nilai_sementara`, `bmb_total_poin_sementara`, `bmb_catatan`, `final_capaian`, `final_nilai_sementara`, `final_total_poin_sementara`, `final_catatan`) VALUES
(3, 12, 0, '', 2022, NULL, '', '', '', NULL, NULL, NULL, '', NULL, 2, '12', '12', 12.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'belum dikerjakan', NULL, NULL, 'belum dikerjakan', '', '', NULL, ''),
(4, 1, 10, NULL, 2023, 53, 'TOTAL PENYALURAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '470.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(5, 1, 11, NULL, 2023, 53, 'REPAYMENT', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '400.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(6, 1, 13, NULL, 2023, 53, 'PENDAPATAN MARGIN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '4.000.000', NULL, 30.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 1, 14, NULL, 2023, 53, 'BINAAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '12.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 1, 15, NULL, 2023, 53, 'PENAMPILAN KERJA', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(9, 1, 16, NULL, 2023, 53, 'KOMUNIKASI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(10, 1, 17, NULL, 2023, 53, 'INISIATIF', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(11, 1, 18, NULL, 2023, 53, 'DISIPLIN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(12, 1, 19, NULL, 2023, 53, 'TANGGUNG JAWAB', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(13, 0, 10, NULL, 2023, 53, 'TOTAL PENYALURAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '470.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(14, 0, 11, NULL, 2023, 53, 'REPAYMENT', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '400.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(15, 0, 13, NULL, 2023, 53, 'PENDAPATAN MARGIN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '4.000.000', NULL, 30.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(16, 0, 14, NULL, 2023, 53, 'BINAAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, '12.000.000', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(17, 0, 15, NULL, 2023, 53, 'PENAMPILAN KERJA', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(18, 0, 16, NULL, 2023, 53, 'KOMUNIKASI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(19, 0, 17, NULL, 2023, 53, 'INISIATIF', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(20, 0, 18, NULL, 2023, 53, 'DISIPLIN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(21, 0, 19, NULL, 2023, 53, 'TANGGUNG JAWAB', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 20.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(22, 1, 20, NULL, 2023, 53, 'MOTIVASI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(23, 1, 21, NULL, 2023, 53, 'KERJASAMA', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(24, 1, 22, NULL, 2023, 53, 'PEMILIHAN LOKASI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(25, 1, 23, NULL, 2023, 53, 'SURVEI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(26, 1, 24, NULL, 2023, 53, 'PERTEMUAN UMUM', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(27, 1, 25, NULL, 2023, 53, 'UJI KELAYAKAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(28, 1, 26, NULL, 2023, 53, 'PRA LWK', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(29, 1, 27, NULL, 2023, 53, 'LWK', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(30, 1, 28, NULL, 2023, 53, 'MEMBUAT LAPORAN', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(31, 1, 29, NULL, 2023, 53, 'PENYESUAIIAN DIRI', NULL, NULL, NULL, NULL, 1, NULL, NULL, NULL, 'A', NULL, 5.000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `smk_pegawai_new`
--

CREATE TABLE `smk_pegawai_new` (
  `id_smk_pegawai` bigint(20) NOT NULL,
  `id_smk_pegawai_tahunan` bigint(20) NOT NULL COMMENT 'ID untuk mengetahui SMK ini menempel kepada pegawai yang mana',
  `type` set('TAHUNAN','PERIODE','UNKNOWN') NOT NULL COMMENT 'Menyatakan type dari SMK. Tahunan atau Per Periode/ Triwulan',
  `tahun` int(4) NOT NULL,
  `id_smk_periode` int(11) DEFAULT NULL COMMENT 'Informasi tentang periode. Misal TRIWULAN I, II, III, IV, dst. Jika typenya TAHUNAN maka boleh dikosongkan',
  `sasaran` varchar(1000) DEFAULT NULL,
  `plan_sasaran` varchar(1200) NOT NULL,
  `real_sasaran` varchar(1200) NOT NULL,
  `id_smk_sasaran_position` bigint(20) DEFAULT NULL,
  `no` int(11) NOT NULL,
  `rev` int(11) DEFAULT 1,
  `rev_pre_sasaran` varchar(100) NOT NULL,
  `id_smk_mst_jenis_penilaian` int(11) NOT NULL,
  `id_aspek_penilaian` int(11) NOT NULL,
  `target` varchar(150) NOT NULL,
  `ukuran_pencapaian` varchar(150) NOT NULL,
  `sub_bobot` double(5,3) NOT NULL,
  `plan_id_smk_mst_jenis_penilaian` int(11) NOT NULL,
  `plan_id_aspek_penilaian` int(11) NOT NULL,
  `plan_target` varchar(150) NOT NULL,
  `plan_ukuran_pencapaian` varchar(150) NOT NULL,
  `plan_sub_bobot` double(5,3) NOT NULL,
  `real_id_smk_mst_jenis_penilaian` int(11) NOT NULL,
  `real_id_aspek_penilaian` int(11) NOT NULL,
  `real_target` varchar(150) NOT NULL,
  `real_ukuran_pencapaian` varchar(150) NOT NULL,
  `real_sub_bobot` double(5,3) NOT NULL,
  `plan_a_rentang_1_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_1_ii` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_i` varchar(150) DEFAULT NULL,
  `plan_a_rentang_2_ii` varchar(150) DEFAULT NULL,
...
--
-- Table structure for table `smk_pegawai_tahunan`
--

CREATE TABLE `smk_pegawai_tahunan` (
  `id_smk_pegawai_tahunan` bigint(20) NOT NULL,
  `type_periode` set('TAHUNAN','PERIODE','UNKNOWN') DEFAULT NULL,
  `id_smk_periode` bigint(20) NOT NULL,
  `year` int(4) NOT NULL,
  `id_pegawai` bigint(20) NOT NULL,
  `id_smk_pegawai_tahunan_parent` bigint(20) DEFAULT NULL,
  `rev_no` int(3) NOT NULL DEFAULT 1,
  `id_hrm_organization_structure` bigint(20) DEFAULT NULL,
  `id_hrm_organization_position` bigint(20) DEFAULT NULL,
  `id_pegawai_atasan` bigint(20) DEFAULT NULL,
  `id_hrm_organization_position_atasan` bigint(20) DEFAULT NULL,
  `id_hrm_kantor` bigint(20) DEFAULT NULL,
  `plan_is_changed` int(1) NOT NULL DEFAULT 0,
  `planchange_is_approved` int(2) DEFAULT NULL,
  `planchange_notes` text DEFAULT NULL,
  `plan_is_approved` int(1) DEFAULT NULL,
  `plan_approval_date` date DEFAULT NULL,
  `plan_approval_id_pegawai` bigint(20) DEFAULT NULL,
  `plan_approval_ip_address` varchar(64) DEFAULT NULL,
  `plan_approval_notes` text DEFAULT NULL,
  `bimb_is_approved` int(1) DEFAULT NULL,
  `bimb_approval_date` date DEFAULT NULL,
  `bimb_approval_id_pegawai` bigint(20) DEFAULT NULL,
  `bimb_approval_ip_address` varchar(64) DEFAULT NULL,
  `bimb_approval_notes` text DEFAULT NULL,
  `is_approved` int(1) DEFAULT NULL,
  `approval_date` date DEFAULT NULL,
  `approval_id_pegawai` bigint(20) DEFAULT NULL,
  `approval_ip_address` varchar(64) DEFAULT NULL,
  `approval_notes` text DEFAULT NULL,
  `nilai_point` double(8,4) DEFAULT NULL,
  `nilai_angka` varchar(20) DEFAULT NULL,
  `keterangan_nilai` varchar(200) DEFAULT NULL,
  `bmb_nilai_point` double(8,4) DEFAULT NULL,
  `bmb_nilai_angka` varchar(20) DEFAULT NULL,
  `bmb_keterangan_nilai` varchar(200) DEFAULT NULL,
  `final_nilai_point` double(8,4) DEFAULT NULL,
  `final_nilai_angka` varchar(20) DEFAULT NULL,
  `final_keterangan_nilai` varchar(200) DEFAULT NULL,
  `keterangan` varchar(250) DEFAULT NULL,
  `plan_status_completed` int(1) DEFAULT NULL,
  `bimb_status_completed` int(1) DEFAULT NULL,
  `final_status_completed` int(1) DEFAULT NULL,
...
--
-- Dumping data for table `smk_pegawai_tahunan`
--

INSERT INTO `smk_pegawai_tahunan` (`id_smk_pegawai_tahunan`, `type_periode`, `id_smk_periode`, `year`, `id_pegawai`, `id_smk_pegawai_tahunan_parent`, `rev_no`, `id_hrm_organization_structure`, `id_hrm_organization_position`, `id_pegawai_atasan`, `id_hrm_organization_position_atasan`, `id_hrm_kantor`, `plan_is_changed`, `planchange_is_approved`, `planchange_notes`, `plan_is_approved`, `plan_approval_date`, `plan_approval_id_pegawai`, `plan_approval_ip_address`, `plan_approval_notes`, `bimb_is_approved`, `bimb_approval_date`, `bimb_approval_id_pegawai`, `bimb_approval_ip_address`, `bimb_approval_notes`, `is_approved`, `approval_date`, `approval_id_pegawai`, `approval_ip_address`, `approval_notes`, `nilai_point`, `nilai_angka`, `keterangan_nilai`, `bmb_nilai_point`, `bmb_nilai_angka`, `bmb_keterangan_nilai`, `final_nilai_point`, `final_nilai_angka`, `final_keterangan_nilai`, `keterangan`, `plan_status_completed`, `bimb_status_completed`, `final_status_completed`, `status`, `filename`, `created_date`, `created_user`, `created_ip_address`) VALUES
(1, NULL, 53, 2023, 37, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, NULL, 54, 2023, 37, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, NULL, 53, 2022, 37, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, NULL, 53, 2021, 37, NULL, 1, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `smk_periode`
--

CREATE TABLE `smk_periode` (
  `id_smk_periode` bigint(20) NOT NULL,
  `id_perusahaan` bigint(20) NOT NULL,
  `id_smk_mst_jenis_periode` bigint(20) NOT NULL,
  `tahun` int(4) NOT NULL,
  `periode_no` int(11) NOT NULL,
  `nama_periode` varchar(250) NOT NULL,
  `is_current_periode` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `smk_periode`
--

INSERT INTO `smk_periode` (`id_smk_periode`, `id_perusahaan`, `id_smk_mst_jenis_periode`, `tahun`, `periode_no`, `nama_periode`, `is_current_periode`) VALUES
(53, 12, 15, 2023, 1, 'Triwulan 1', 1),
(54, 12, 15, 2023, 2, 'Triwulan 2', 0),
(55, 12, 15, 2023, 3, 'Triwulan 3', 0),
(56, 12, 15, 2023, 4, 'Triwulan 4', 0),
(57, 12, 15, 2022, 5, 'Triwulan 1 - 22', 0),
(58, 12, 15, 2022, 6, 'Triwulan 2', 0),
(59, 12, 15, 2022, 7, 'Triwulan 3', 0),
(60, 12, 15, 2022, 8, 'Triwulan 4', 0);
...
(5, 'cicak', 'cicak', 'badak@gmail.com', '$2y$13$vA0RvFcMne4YmTiaNhK/iu.oED5ViTD84f63F8W/ElMTILcQtoKFq', 'E2TwV7p0va1Mx7d_hc0p7kixVe6n8DFI', 10, 'Znib2lA4kDw4Kb0H_E_6_h5Ae5pHIq6j_1633413050', 'sales', 10, 1633413050, 1680336131, ''),
...
(37, 'Meli', '89111', '', '$2y$13$IjWDMm5mq5vysbG7HnqjDOZTBCHGzTN2tGMXRH2qc..16j0IxohnK', 'z2I--FcmILNS_RMYz7QB57DvqXJtWy1Z', 10, 'y81vtILIQRtJl_9lbbJfcBMjM2mO2upg_1685954344', 'member', 10, 1685954344, 1685954344, '25df72eb261afb97ce54f4a41d1350b9');
...
--
-- Indexes for table `hrm_kantor`
--
ALTER TABLE `hrm_kantor`
  ADD PRIMARY KEY (`id_hrm_kantor`),
  ADD KEY `id_kantor_kategori` (`id_kantor_kategori`);
...
--
-- Indexes for table `smk_aspek_rencana`
--
ALTER TABLE `smk_aspek_rencana`
  ADD PRIMARY KEY (`id_smk_aspek_rencana`),
  ADD KEY `type` (`type`),
  ADD KEY `tahun` (`tahun`),
  ADD KEY `id_smk_periode` (`id_smk_periode`),
  ADD KEY `id_smk_sasaran_position` (`id_smk_sasaran_position`),
  ADD KEY `id_smk_mst_jenis_penilaian` (`id_smk_mst_jenis_penilaian`),
  ADD KEY `id_aspek_penilaian` (`id_aspek_penilaian`),
  ADD KEY `plan_id_smk_mst_jenis_penilaian` (`plan_id_smk_mst_jenis_penilaian`),
  ADD KEY `plan_id_aspek_penilaian` (`plan_id_aspek_penilaian`);

--
-- Indexes for table `smk_aspek_rentang_nilai`
--
ALTER TABLE `smk_aspek_rentang_nilai`
  ADD PRIMARY KEY (`id_smk_aspek_rentang_nilai`);

--
-- Indexes for table `smk_jenis_penilaian`
--
ALTER TABLE `smk_jenis_penilaian`
  ADD PRIMARY KEY (`id_smk_jenis_penilaian`);

--
-- Indexes for table `smk_mst_jenis_periode`
--
ALTER TABLE `smk_mst_jenis_periode`
  ADD PRIMARY KEY (`id_smk_mst_jenis_periode`),
  ADD KEY `id_perusahaan` (`id_perusahaan`);

--
-- Indexes for table `smk_pegawai`
--
ALTER TABLE `smk_pegawai`
  ADD PRIMARY KEY (`id_smk_pegawai`),
  ADD KEY `id_smk_pegawai_tahunan` (`id_smk_pegawai_tahunan`),
  ADD KEY `type` (`type`),
  ADD KEY `tahun` (`tahun`),
  ADD KEY `id_smk_periode` (`id_smk_periode`),
  ADD KEY `id_smk_sasaran_position` (`id_smk_sasaran_position`),
  ...
  ADD KEY `plan_id_smk_mst_jenis_penilaian` (`plan_id_smk_mst_jenis_penilaian`),
  ADD KEY `plan_id_aspek_penilaian` (`plan_id_aspek_penilaian`),
  ADD KEY `real_id_smk_mst_jenis_penilaian` (`real_id_smk_mst_jenis_penilaian`),
  ADD KEY `real_id_aspek_penilaian` (`real_id_aspek_penilaian`);

--
-- Indexes for table `smk_pegawai_new`
--
ALTER TABLE `smk_pegawai_new`
  ADD PRIMARY KEY (`id_smk_pegawai`),
  ADD KEY `id_smk_pegawai_tahunan` (`id_smk_pegawai_tahunan`),
  ADD KEY `type` (`type`),
  ADD KEY `tahun` (`tahun`),
...
--
-- Indexes for table `smk_pegawai_tahunan`
--
ALTER TABLE `smk_pegawai_tahunan`
  ADD PRIMARY KEY (`id_smk_pegawai_tahunan`),
  ADD KEY `id_hrm_organization_position` (`id_pegawai`),
  ADD KEY `year` (`year`),
  ADD KEY `status` (`status`),
  ADD KEY `id_hrm_kantor` (`id_hrm_kantor`),
  ADD KEY `approval_id_pegawai` (`approval_id_pegawai`),
  ADD KEY `id_smk_pegawai_tahunan_parent` (`id_smk_pegawai_tahunan_parent`);

--
-- Indexes for table `smk_periode`
--
ALTER TABLE `smk_periode`
  ADD PRIMARY KEY (`id_smk_periode`);
...
--
ALTER TABLE `hrm_cv_riwayat_pendidikan`
  MODIFY `id_riwayat_pendidikan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `hrm_kantor`
--
ALTER TABLE `hrm_kantor`
  MODIFY `id_hrm_kantor` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11576;
...
--
ALTER TABLE `hrm_pegawai`
  MODIFY `id_pegawai` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `mst_jabatan_attribute`
  MODIFY `id_mst_jabatan_attribute` bigint(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `mst_jabatan_attribute_grade`
--
ALTER TABLE `mst_jabatan_attribute_grade`
  MODIFY `id_mst_jabatan_attribute_grade` bigint(20) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `pro_personal_attribute`
  MODIFY `id_pro_personal_attribute` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `smk_aspek_penilaian`
  MODIFY `id_aspek_penilaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `smk_aspek_rencana`
--
ALTER TABLE `smk_aspek_rencana`
  MODIFY `id_smk_aspek_rencana` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `smk_aspek_rentang_nilai`
--
ALTER TABLE `smk_aspek_rentang_nilai`
  MODIFY `id_smk_aspek_rentang_nilai` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `smk_jenis_penilaian`
--
ALTER TABLE `smk_jenis_penilaian`
  MODIFY `id_smk_jenis_penilaian` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `smk_mst_jenis_periode`
--
ALTER TABLE `smk_mst_jenis_periode`
  MODIFY `id_smk_mst_jenis_periode` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT for table `smk_pegawai`
--
ALTER TABLE `smk_pegawai`
  MODIFY `id_smk_pegawai` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;

--
-- AUTO_INCREMENT for table `smk_pegawai_new`
--
ALTER TABLE `smk_pegawai_new`
  MODIFY `id_smk_pegawai` bigint(20) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `smk_pegawai_tahunan`
--
ALTER TABLE `smk_pegawai_tahunan`
  MODIFY `id_smk_pegawai_tahunan` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `smk_periode`
--
ALTER TABLE `smk_periode`
  MODIFY `id_smk_periode` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=61;
